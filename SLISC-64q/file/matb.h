...
inline void save(Qdoub_I s, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(Qdoub_I s, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(s, varname, matb);
	matb.close();
...
inline void save(Qcomp_I s, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(Qcomp_I s, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(s, varname, matb);
	matb.close();
...
inline void save(SvecInt_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(SvecInt_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(SvecQdoub_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(SvecQdoub_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(SvecQcomp_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(SvecQcomp_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(DvecQdoub_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(DvecQdoub_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(DvecQcomp_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(DvecQcomp_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(ScmatChar_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(ScmatChar_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(ScmatQdoub_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(ScmatQdoub_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(ScmatQcomp_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(ScmatQcomp_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(DcmatQdoub_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(DcmatQdoub_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(DcmatQcomp_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(DcmatQcomp_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(CmobdDoub_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(CmobdDoub_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(CmobdQdoub_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(CmobdQdoub_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(CmobdComp_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(CmobdComp_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(CmobdQcomp_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(CmobdQcomp_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(McooDoub_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(McooDoub_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(McooQdoub_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(McooQdoub_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(McooComp_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(McooComp_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(McooQcomp_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(McooQcomp_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(Scmat3Int_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(Scmat3Int_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(Scmat3Llong_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(Scmat3Llong_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(Scmat3Doub_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(Scmat3Doub_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(Scmat3Qdoub_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(Scmat3Qdoub_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(Scmat3Comp_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(Scmat3Comp_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(Scmat3Qcomp_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(Scmat3Qcomp_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(Scmat4Doub_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(Scmat4Doub_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(Scmat4Qdoub_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(Scmat4Qdoub_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(Scmat4Comp_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(Scmat4Comp_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void save(Scmat4Qcomp_I v, Str_I varname, Matb_IO matb)
{
	if (matb.search(varname) >= 0)
		SLS_ERR("variable already exist: " + varname);
	ofstream &fout = matb.m_out;
...
inline void save_matb(Scmat4Qcomp_I v, Str_I varname, Str_I matb_file, Bool_I replace = false)
{
	Matb matb(matb_file, "w", replace);
	save(v, varname, matb);
	matb.close();
...
inline void load(Qdoub_O s, Str_I varname, Matb_IO matb)
{
	ifstream &fin = matb.m_in;
	Long i = matb.search(varname);
	if (i < 0)
...
inline void load_matb(Qdoub_O var, Str_I varname, Str_I matb_file)
{
	Matb matb(matb_file, "r");
	load(var, varname, matb);
	matb.close();
...
inline void load(Qcomp_O s, Str_I varname, Matb_IO matb)
{
	ifstream &fin = matb.m_in;
	Long i = matb.search(varname);
	if (i < 0)
...
inline void load_matb(Qcomp_O var, Str_I varname, Str_I matb_file)
{
	Matb matb(matb_file, "r");
	load(var, varname, matb);
	matb.close();
