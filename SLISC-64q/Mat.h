...
public:
	using Base::p;
	MatQdoub(): m_N0(0), m_N1(0) {};
	MatQdoub(Long_I N0, Long_I N1);
	MatQdoub(const MatQdoub &rhs);        // Copy constructor
	MatQdoub &operator=(const MatQdoub &rhs) = delete;
	void operator<<(MatQdoub &rhs); // move data and rhs.resize(0, 0)
...
inline MatQdoub::MatQdoub(Long_I N0, Long_I N1) : Base(N0*N1), m_N0(N0), m_N1(N1) {}

inline MatQdoub::MatQdoub(const MatQdoub &rhs) : Base(0)
{
	SLS_ERR("Copy constructor or move constructor is forbidden, use reference argument for function input or output, and use \"=\" to copy!");
}

inline void MatQdoub::operator<<(MatQdoub &rhs)
{
	m_N0 = rhs.m_N0; m_N1 = rhs.m_N1;
	rhs.m_N0 = rhs.m_N1 = 0;
	Base::operator<<(rhs);
...
inline Qdoub& MatQdoub::operator()(Long_I i, Long_I j)
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1)
...
inline const Qdoub &MatQdoub::operator()(Long_I i, Long_I j) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1)
	    SLS_ERR("MatQdoub subscript out of bounds");
...
inline Long MatQdoub::n0() const
{
	return m_N0;
}

inline Long MatQdoub::n1() const
{
	return m_N1;
}
...
public:
	using Base::p;
	MatQcomp(): m_N0(0), m_N1(0) {};
	MatQcomp(Long_I N0, Long_I N1);
	MatQcomp(const MatQcomp &rhs);        // Copy constructor
	MatQcomp &operator=(const MatQcomp &rhs) = delete;
	void operator<<(MatQcomp &rhs); // move data and rhs.resize(0, 0)
...
inline MatQcomp::MatQcomp(Long_I N0, Long_I N1) : Base(N0*N1), m_N0(N0), m_N1(N1) {}

inline MatQcomp::MatQcomp(const MatQcomp &rhs) : Base(0)
{
	SLS_ERR("Copy constructor or move constructor is forbidden, use reference argument for function input or output, and use \"=\" to copy!");
}

inline void MatQcomp::operator<<(MatQcomp &rhs)
{
	m_N0 = rhs.m_N0; m_N1 = rhs.m_N1;
	rhs.m_N0 = rhs.m_N1 = 0;
	Base::operator<<(rhs);
...
inline Qcomp& MatQcomp::operator()(Long_I i, Long_I j)
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1)
...
inline const Qcomp &MatQcomp::operator()(Long_I i, Long_I j) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1)
	    SLS_ERR("MatQcomp subscript out of bounds");
...
inline Long MatQcomp::n0() const
{
	return m_N0;
}

inline Long MatQcomp::n1() const
{
	return m_N1;
}
