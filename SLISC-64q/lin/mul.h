...
inline void mul(VecQdoub_O y, CmatQdoub_I a, SvecQdoub_I x)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
// y = alpha*A*x + beta*y
// algorithm: y = alpha*(A*x + beta/alpha *y)
inline void mul(VecQdoub_IO y, CmatQdoub_I a, SvecQdoub_I x, Qdoub_I alpha, Qdoub_I beta)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
inline void mul(VecQcomp_O y, CmatQdoub_I a, VecQcomp_I x)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
// y = alpha*A*x + beta*y
// algorithm: y = alpha*(A*x + beta/alpha *y)
inline void mul(VecQcomp_IO y, CmatQdoub_I a, VecQcomp_I x, Qdoub_I alpha, Qcomp_I beta)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
inline void mul(VecQcomp_O y, ScmatQdoub_I a, VecQcomp_I x)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
// y = alpha*A*x + beta*y
// algorithm: y = alpha*(A*x + beta/alpha *y)
inline void mul(VecQcomp_IO y, ScmatQdoub_I a, VecQcomp_I x, Qdoub_I alpha, Qcomp_I beta)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
inline void mul(SvecQcomp_O y, CmatQdoub_I a, SvecQcomp_I x)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
// y = alpha*A*x + beta*y
// algorithm: y = alpha*(A*x + beta/alpha *y)
inline void mul(SvecQcomp_IO y, CmatQdoub_I a, SvecQcomp_I x, Qdoub_I alpha, Qcomp_I beta)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
inline void mul(DvecQcomp_O y, CmatQdoub_I a, DvecQcomp_I x)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
// y = alpha*A*x + beta*y
// algorithm: y = alpha*(A*x + beta/alpha *y)
inline void mul(DvecQcomp_IO y, CmatQdoub_I a, DvecQcomp_I x, Qdoub_I alpha, Qcomp_I beta)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
inline void mul(VecQcomp_O y, ScmatQcomp_I a, SvecQdoub_I x)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
// y = alpha*A*x + beta*y
// algorithm: y = alpha*(A*x + beta/alpha *y)
inline void mul(VecQcomp_IO y, ScmatQcomp_I a, SvecQdoub_I x, Qcomp_I alpha, Qcomp_I beta)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
inline void mul(SvecQcomp_O y, ScmatQcomp_I a, SvecQdoub_I x)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
// y = alpha*A*x + beta*y
// algorithm: y = alpha*(A*x + beta/alpha *y)
inline void mul(SvecQcomp_IO y, ScmatQcomp_I a, SvecQdoub_I x, Qcomp_I alpha, Qcomp_I beta)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
inline void mul(VecQcomp_O y, ScmatQcomp_I a, SvecQcomp_I x)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
// y = alpha*A*x + beta*y
// algorithm: y = alpha*(A*x + beta/alpha *y)
inline void mul(VecQcomp_IO y, ScmatQcomp_I a, SvecQcomp_I x, Qcomp_I alpha, Qcomp_I beta)
{
	Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
	if (Nc != x.size() || y.size() != Nr)
...
// y = alpha*A*x + beta*y
inline void mul_gen(VecQdoub_O y, CmatQdoub_I a, SvecQdoub_I x, Qdoub_I alpha = 1, Qdoub_I beta = 0)
{
#ifdef SLS_CHECK_SHAPES
	if (x.size() != a.n1() || y.size() != a.n0())
		SLS_ERR("wrong shape!");
...
// y = alpha*A*x + beta*y
inline void mul_gen(VecQcomp_O y, CmatQdoub_I a, VecQcomp_I x, Qdoub_I alpha = 1, Qdoub_I beta = 0)
{
#ifdef SLS_CHECK_SHAPES
	if (x.size() != a.n1() || y.size() != a.n0())
		SLS_ERR("wrong shape!");
...
// y = alpha*A*x + beta*y
inline void mul_gen(VecQcomp_O y, ScmatQdoub_I a, VecQcomp_I x, Qdoub_I alpha = 1, Qdoub_I beta = 0)
{
#ifdef SLS_CHECK_SHAPES
	if (x.size() != a.n1() || y.size() != a.n0())
		SLS_ERR("wrong shape!");
...
// y = alpha*A*x + beta*y
inline void mul_gen(VecQdoub_O y, CmatQdoub_I a, VecQdoub_I x, Qdoub_I alpha = 1, Qdoub_I beta = 0)
{
#ifdef SLS_CHECK_SHAPES
	if (x.size() != a.n1() || y.size() != a.n0())
		SLS_ERR("wrong shape!");
...
// y = alpha*A*x + beta*y
inline void mul_gen(SvecQcomp_O y, CmatQdoub_I a, SvecQcomp_I x, Qdoub_I alpha = 1, Qdoub_I beta = 0)
{
#ifdef SLS_CHECK_SHAPES
	if (x.size() != a.n1() || y.size() != a.n0())
		SLS_ERR("wrong shape!");
...
// y = alpha*A*x + beta*y
inline void mul_gen(DvecQcomp_O y, CmatQdoub_I a, DvecQcomp_I x, Qdoub_I alpha = 1, Qdoub_I beta = 0)
{
#ifdef SLS_CHECK_SHAPES
	if (x.size() != a.n1() || y.size() != a.n0())
		SLS_ERR("wrong shape!");
...
// y = alpha*A*x + beta*y
inline void mul_gen(VecQcomp_O y, ScmatQcomp_I a, SvecQcomp_I x, Qcomp_I alpha = 1, Qcomp_I beta = 0)
{
#ifdef SLS_CHECK_SHAPES
	if (x.size() != a.n1() || y.size() != a.n0())
		SLS_ERR("wrong shape!");
