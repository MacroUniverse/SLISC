...
public:
	...
	SvbaseQdoubC(const SvbaseQdoubC &v) = default; // copy constructor (shalow)

	SvbaseQdoubC &operator=(const SvbaseQdoubC &v) = default; // copy assignment (shalow)
...
public:
	...
	SvbaseQdoub(const SvbaseQdoub &v) = default; // copy constructor (shalow)

	SvbaseQdoub &operator=(const SvbaseQdoub &v) = default; // copy assignment (shalow)
	...
	operator const SvbaseQdoubC &() const;
	operator SvbaseQdoubC &();
...
inline SvbaseQdoub::operator const SvbaseQdoubC &() const
{
	return reinterpret_cast<const SvbaseQdoubC &>(*this);
}

inline SvbaseQdoub::operator SvbaseQdoubC &()
{
	return reinterpret_cast<SvbaseQdoubC &>(*this);
}
...
public:
	...
	SvbaseQcompC(const SvbaseQcompC &v) = default; // copy constructor (shalow)

	SvbaseQcompC &operator=(const SvbaseQcompC &v) = default; // copy assignment (shalow)
...
public:
	...
	SvbaseQcomp(const SvbaseQcomp &v) = default; // copy constructor (shalow)

	SvbaseQcomp &operator=(const SvbaseQcomp &v) = default; // copy assignment (shalow)
	...
	operator const SvbaseQcompC &() const;
	operator SvbaseQcompC &();
...
inline SvbaseQcomp::operator const SvbaseQcompC &() const
{
	return reinterpret_cast<const SvbaseQcompC &>(*this);
}

inline SvbaseQcomp::operator SvbaseQcompC &()
{
	return reinterpret_cast<SvbaseQcompC &>(*this);
}
...
public:
	...
	SvbaseQimagC(const SvbaseQimagC &v) = default; // copy constructor (shalow)

	SvbaseQimagC &operator=(const SvbaseQimagC &v) = default; // copy assignment (shalow)
...
public:
	...
	SvbaseQimag(const SvbaseQimag &v) = default; // copy constructor (shalow)

	SvbaseQimag &operator=(const SvbaseQimag &v) = default; // copy assignment (shalow)
	...
	operator const SvbaseQimagC &() const;
	operator SvbaseQimagC &();
...
inline SvbaseQimag::operator const SvbaseQimagC &() const
{
	return reinterpret_cast<const SvbaseQimagC &>(*this);
}

inline SvbaseQimag::operator SvbaseQimagC &()
{
	return reinterpret_cast<SvbaseQimagC &>(*this);
}
