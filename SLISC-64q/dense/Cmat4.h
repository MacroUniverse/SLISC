...
namespace slisc {
class Cmat4Bool : protected VbaseBool
{
protected:
	typedef VbaseBool Base;
	Long m_N0, m_N1, m_N2, m_N3;
public:
	Cmat4Bool(): m_N0(0), m_N1(0), m_N2(0), m_N3(0) {};
	Cmat4Bool(Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	Cmat4Bool(const Cmat4Bool &rhs);   // copy constructor
	Cmat4Bool(Cmat4Bool &&rhs);   // move constructor
	Cmat4Bool &operator=(const Cmat4Bool &rhs); // copy assignment
	using Base::p;
	using Base::size;
	using Base::operator[];
	using Base::end;
	...
	Bool &operator()(Long_I i, Long_I j, Long_I k, Long_I l);
	...
	operator const Scmat4Bool&();
};

inline Cmat4Bool::Cmat4Bool(Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: Base(N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}

// Copy constructor
inline Cmat4Bool::Cmat4Bool(const Cmat4Bool &rhs): Base(rhs),
...
inline Cmat4Bool::Cmat4Bool(Cmat4Bool &&rhs)
	: Base(std::move(rhs)), m_N0(rhs.m_N0), m_N1(rhs.m_N1), m_N2(rhs.m_N2), m_N3(rhs.m_N3) {}

inline Cmat4Bool &Cmat4Bool::operator=(const Cmat4Bool &rhs)
{
	Base::operator=(rhs);
...
inline void Cmat4Bool::resize(Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
...
inline void Cmat4Bool::reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
#ifdef SLS_CHECK_SHAPES
	if (N0*N1*N2*N2 != m_N) {
		stringstream ss;
		ss  << "Cmat4Bool reshaping from (" << m_N0 << ',' << m_N1
...
inline Bool &Cmat4Bool::operator()(Long_I i, Long_I j, Long_I k, Long_I l)
{
...
inline const Bool &Cmat4Bool::operator()(Long_I i, Long_I j, Long_I k, Long_I l) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1 ||
		k < 0 || k >= m_N2 || l < 0 || l >= m_N3)
...
inline Long Cmat4Bool::n0() const {
	return m_N0;
}

inline Long Cmat4Bool::n1() const {
	return m_N1;
}

inline Long Cmat4Bool::n2() const {
	return m_N2;
}

inline Long Cmat4Bool::n3() const {
	return m_N3;
}

inline Cmat4Bool::operator const Scmat4BoolC&() const {
	return reinterpret_cast<const Scmat4BoolC&>(*this);
}

inline Cmat4Bool::operator const Scmat4Bool&() {
	return reinterpret_cast<const Scmat4Bool&>(*this);
}

typedef const Cmat4Bool &Cmat4Bool_I;
typedef Cmat4Bool &Cmat4Bool_O, &Cmat4Bool_IO;


class Cmat4Char : protected VbaseChar
{
protected:
...
class Cmat4Int : protected VbaseInt
{
protected:
...
class Cmat4Llong : protected VbaseLlong
{
protected:
...
class Cmat4Float : protected VbaseFloat
{
protected:
...
class Cmat4Doub : protected VbaseDoub
{
protected:
...
class Cmat4Ldoub : protected VbaseLdoub
{
protected:
...
class Cmat4Qdoub : protected VbaseQdoub
{
protected:
...
inline Cmat4Qdoub::operator const Scmat4QdoubC&() const {
	return reinterpret_cast<const Scmat4QdoubC&>(*this);
}

inline Cmat4Qdoub::operator const Scmat4Qdoub&() {
	return reinterpret_cast<const Scmat4Qdoub&>(*this);
}
...
class Cmat4Fcomp : protected VbaseFcomp
{
protected:
...
class Cmat4Comp : protected VbaseComp
{
protected:
...
class Cmat4Lcomp : protected VbaseLcomp
{
protected:
...
class Cmat4Qcomp : protected VbaseQcomp
{
protected:
...
inline Cmat4Qcomp::operator const Scmat4QcompC&() const {
	return reinterpret_cast<const Scmat4QcompC&>(*this);
}

inline Cmat4Qcomp::operator const Scmat4Qcomp&() {
	return reinterpret_cast<const Scmat4Qcomp&>(*this);
}
...
class Cmat4Fimag : protected VbaseFimag
{
protected:
...
class Cmat4Imag : protected VbaseImag
{
protected:
...
class Cmat4Limag : protected VbaseLimag
{
protected:
...
class Cmat4Qimag : protected VbaseQimag
{
protected:
...
inline Cmat4Qimag::operator const Scmat4QimagC&() const {
	return reinterpret_cast<const Scmat4QimagC&>(*this);
}

inline Cmat4Qimag::operator const Scmat4Qimag&() {
	return reinterpret_cast<const Scmat4Qimag&>(*this);
}
