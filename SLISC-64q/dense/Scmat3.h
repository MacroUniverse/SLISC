...
inline Scmat3Qdoub::operator Scmat3QdoubC &()
{
	return reinterpret_cast<Scmat3QdoubC &>(*this);
}
...
inline Scmat3Qcomp::operator Scmat3QcompC &()
{
	return reinterpret_cast<Scmat3QcompC &>(*this);
}
