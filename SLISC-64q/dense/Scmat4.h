...
namespace slisc {
class Scmat4BoolC : public SvbaseBoolC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
	Scmat4BoolC();
	Scmat4BoolC(const Bool *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);


	const Bool &operator()(Long_I i, Long_I j, Long_I k, Long_I l) const;
	...
	void set(const Bool *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	~Scmat4BoolC();
};

inline Scmat4BoolC::Scmat4BoolC() {}

inline Scmat4BoolC::Scmat4BoolC(const Bool *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseBoolC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}


inline const Bool &Scmat4BoolC::operator()(Long_I i, Long_I j, Long_I k, Long_I l) const
{
...
inline Long Scmat4BoolC::n0() const
{
	return m_N0;
}

inline Long Scmat4BoolC::n1() const
{
	return m_N1;
}

inline Long Scmat4BoolC::n2() const
{
	return m_N2;
}

inline Long Scmat4BoolC::n3() const
{
	return m_N3;
}

inline void Scmat4BoolC::reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
...
inline void Scmat4BoolC::set(const Bool *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
	SvbaseBoolC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}

inline Scmat4BoolC::~Scmat4BoolC() {}

typedef const Scmat4BoolC &Scmat4Bool_I;


class Scmat4Bool : public SvbaseBool
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
	Scmat4Bool();
	Scmat4Bool(Bool *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);

	operator const Scmat4BoolC &() const;
	operator Scmat4BoolC &();

	Bool &operator()(Long_I i, Long_I j, Long_I k, Long_I l) const;
	...
	// resize() is a bad idea, don't try to create it!
	void reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	void set(Bool *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	~Scmat4Bool();
};

inline Scmat4Bool::Scmat4Bool() {}

inline Scmat4Bool::Scmat4Bool(Bool *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseBool(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}

inline Scmat4Bool::operator const Scmat4BoolC &() const
{
	return reinterpret_cast<const Scmat4BoolC &>(*this);
}

inline Scmat4Bool::operator Scmat4BoolC &()
{
	return reinterpret_cast<Scmat4BoolC &>(*this);
}

inline Bool &Scmat4Bool::operator()(Long_I i, Long_I j, Long_I k, Long_I l) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1 || k < 0 || k >= m_N2 || l < 0 || l >= m_N3)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Long Scmat4Bool::n0() const
{
	return m_N0;
}

inline Long Scmat4Bool::n1() const
{
	return m_N1;
}

inline Long Scmat4Bool::n2() const
{
	return m_N2;
}

inline Long Scmat4Bool::n3() const
{
	return m_N3;
}

inline void Scmat4Bool::reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
#ifdef SLS_CHECK_SHAPES
	if (N0*N1*N2*N3 != m_N)
		SLS_ERR("illegal reshape!");
...
inline void Scmat4Bool::set(Bool *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
	SvbaseBool::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
typedef const Scmat4Bool &Scmat4Bool_O, &Scmat4Bool_IO;


class Scmat4CharC : public SvbaseCharC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4CharC::Scmat4CharC(const Char *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseCharC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseCharC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4Char : public SvbaseChar
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4Char::Scmat4Char(Char *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseChar(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseChar::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4UcharC : public SvbaseUcharC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4UcharC::Scmat4UcharC(const Uchar *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseUcharC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseUcharC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4Uchar : public SvbaseUchar
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4Uchar::Scmat4Uchar(Uchar *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseUchar(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseUchar::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4IntC : public SvbaseIntC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4IntC::Scmat4IntC(const Int *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseIntC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseIntC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4Int : public SvbaseInt
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4Int::Scmat4Int(Int *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseInt(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseInt::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4LlongC : public SvbaseLlongC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4LlongC::Scmat4LlongC(const Llong *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseLlongC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseLlongC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4Llong : public SvbaseLlong
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4Llong::Scmat4Llong(Llong *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseLlong(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseLlong::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4FloatC : public SvbaseFloatC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4FloatC::Scmat4FloatC(const Float *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseFloatC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseFloatC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4Float : public SvbaseFloat
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4Float::Scmat4Float(Float *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseFloat(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseFloat::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4DoubC : public SvbaseDoubC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4DoubC::Scmat4DoubC(const Doub *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseDoubC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseDoubC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4Doub : public SvbaseDoub
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4Doub::Scmat4Doub(Doub *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseDoub(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseDoub::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4QdoubC : public SvbaseQdoubC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
	Scmat4QdoubC();
	Scmat4QdoubC(const Qdoub *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	...
	// resize() is a bad idea, don't try to create it!
	void reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	void set(const Qdoub *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	~Scmat4QdoubC();
};

inline Scmat4QdoubC::Scmat4QdoubC() {}

inline Scmat4QdoubC::Scmat4QdoubC(const Qdoub *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseQdoubC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}


inline const Qdoub &Scmat4QdoubC::operator()(Long_I i, Long_I j, Long_I k, Long_I l) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1 || k < 0 || k >= m_N2 || l < 0 || l >= m_N3)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Long Scmat4QdoubC::n0() const
{
	return m_N0;
}

inline Long Scmat4QdoubC::n1() const
{
	return m_N1;
}

inline Long Scmat4QdoubC::n2() const
{
	return m_N2;
}

inline Long Scmat4QdoubC::n3() const
{
	return m_N3;
}

inline void Scmat4QdoubC::reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
#ifdef SLS_CHECK_SHAPES
	if (N0*N1*N2*N3 != m_N)
		SLS_ERR("illegal reshape!");
...
inline void Scmat4QdoubC::set(const Qdoub *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
	SvbaseQdoubC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}

inline Scmat4QdoubC::~Scmat4QdoubC() {}

typedef const Scmat4QdoubC &Scmat4Qdoub_I;


class Scmat4Qdoub : public SvbaseQdoub
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
	Scmat4Qdoub();
	Scmat4Qdoub(Qdoub *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);

	operator const Scmat4QdoubC &() const;
	operator Scmat4QdoubC &();

	Qdoub &operator()(Long_I i, Long_I j, Long_I k, Long_I l) const;
	...
	// resize() is a bad idea, don't try to create it!
	void reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	void set(Qdoub *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	~Scmat4Qdoub();
};

inline Scmat4Qdoub::Scmat4Qdoub() {}

inline Scmat4Qdoub::Scmat4Qdoub(Qdoub *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseQdoub(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}

inline Scmat4Qdoub::operator const Scmat4QdoubC &() const
{
	return reinterpret_cast<const Scmat4QdoubC &>(*this);
}

inline Scmat4Qdoub::operator Scmat4QdoubC &()
{
	return reinterpret_cast<Scmat4QdoubC &>(*this);
}

inline Qdoub &Scmat4Qdoub::operator()(Long_I i, Long_I j, Long_I k, Long_I l) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1 || k < 0 || k >= m_N2 || l < 0 || l >= m_N3)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Long Scmat4Qdoub::n0() const
{
	return m_N0;
}

inline Long Scmat4Qdoub::n1() const
{
	return m_N1;
}

inline Long Scmat4Qdoub::n2() const
{
	return m_N2;
}

inline Long Scmat4Qdoub::n3() const
{
	return m_N3;
}

inline void Scmat4Qdoub::reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
#ifdef SLS_CHECK_SHAPES
	if (N0*N1*N2*N3 != m_N)
		SLS_ERR("illegal reshape!");
...
inline void Scmat4Qdoub::set(Qdoub *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
	SvbaseQdoub::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
// use "const" so that it can be bind to a temporary e.g. copy(cut0(a), cut0(b))
typedef const Scmat4Qdoub &Scmat4Qdoub_O, &Scmat4Qdoub_IO;


class Scmat4LdoubC : public SvbaseLdoubC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4LdoubC::Scmat4LdoubC(const Ldoub *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseLdoubC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseLdoubC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4Ldoub : public SvbaseLdoub
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4Ldoub::Scmat4Ldoub(Ldoub *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseLdoub(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseLdoub::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4FcompC : public SvbaseFcompC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4FcompC::Scmat4FcompC(const Fcomp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseFcompC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseFcompC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4Fcomp : public SvbaseFcomp
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4Fcomp::Scmat4Fcomp(Fcomp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseFcomp(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseFcomp::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4CompC : public SvbaseCompC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4CompC::Scmat4CompC(const Comp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseCompC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseCompC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4Comp : public SvbaseComp
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4Comp::Scmat4Comp(Comp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseComp(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseComp::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4LcompC : public SvbaseLcompC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4LcompC::Scmat4LcompC(const Lcomp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseLcompC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseLcompC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4Lcomp : public SvbaseLcomp
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4Lcomp::Scmat4Lcomp(Lcomp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseLcomp(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseLcomp::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4QcompC : public SvbaseQcompC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
	Scmat4QcompC();
	Scmat4QcompC(const Qcomp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	...
	// resize() is a bad idea, don't try to create it!
	void reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	void set(const Qcomp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	~Scmat4QcompC();
};

inline Scmat4QcompC::Scmat4QcompC() {}

inline Scmat4QcompC::Scmat4QcompC(const Qcomp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseQcompC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}


inline const Qcomp &Scmat4QcompC::operator()(Long_I i, Long_I j, Long_I k, Long_I l) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1 || k < 0 || k >= m_N2 || l < 0 || l >= m_N3)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Long Scmat4QcompC::n0() const
{
	return m_N0;
}

inline Long Scmat4QcompC::n1() const
{
	return m_N1;
}

inline Long Scmat4QcompC::n2() const
{
	return m_N2;
}

inline Long Scmat4QcompC::n3() const
{
	return m_N3;
}

inline void Scmat4QcompC::reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
#ifdef SLS_CHECK_SHAPES
	if (N0*N1*N2*N3 != m_N)
		SLS_ERR("illegal reshape!");
...
inline void Scmat4QcompC::set(const Qcomp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
	SvbaseQcompC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}

inline Scmat4QcompC::~Scmat4QcompC() {}

typedef const Scmat4QcompC &Scmat4Qcomp_I;


class Scmat4Qcomp : public SvbaseQcomp
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
	Scmat4Qcomp();
	Scmat4Qcomp(Qcomp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);

	operator const Scmat4QcompC &() const;
	operator Scmat4QcompC &();

	Qcomp &operator()(Long_I i, Long_I j, Long_I k, Long_I l) const;
	...
	// resize() is a bad idea, don't try to create it!
	void reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	void set(Qcomp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	~Scmat4Qcomp();
};

inline Scmat4Qcomp::Scmat4Qcomp() {}

inline Scmat4Qcomp::Scmat4Qcomp(Qcomp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseQcomp(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}

inline Scmat4Qcomp::operator const Scmat4QcompC &() const
{
	return reinterpret_cast<const Scmat4QcompC &>(*this);
}

inline Scmat4Qcomp::operator Scmat4QcompC &()
{
	return reinterpret_cast<Scmat4QcompC &>(*this);
}

inline Qcomp &Scmat4Qcomp::operator()(Long_I i, Long_I j, Long_I k, Long_I l) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1 || k < 0 || k >= m_N2 || l < 0 || l >= m_N3)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Long Scmat4Qcomp::n0() const
{
	return m_N0;
}

inline Long Scmat4Qcomp::n1() const
{
	return m_N1;
}

inline Long Scmat4Qcomp::n2() const
{
	return m_N2;
}

inline Long Scmat4Qcomp::n3() const
{
	return m_N3;
}

inline void Scmat4Qcomp::reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
#ifdef SLS_CHECK_SHAPES
	if (N0*N1*N2*N3 != m_N)
		SLS_ERR("illegal reshape!");
...
inline void Scmat4Qcomp::set(Qcomp *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
	SvbaseQcomp::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
// use "const" so that it can be bind to a temporary e.g. copy(cut0(a), cut0(b))
typedef const Scmat4Qcomp &Scmat4Qcomp_O, &Scmat4Qcomp_IO;


class Scmat4FimagC : public SvbaseFimagC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4FimagC::Scmat4FimagC(const Fimag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseFimagC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseFimagC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4Fimag : public SvbaseFimag
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4Fimag::Scmat4Fimag(Fimag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseFimag(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseFimag::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4ImagC : public SvbaseImagC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4ImagC::Scmat4ImagC(const Imag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseImagC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseImagC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4Imag : public SvbaseImag
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4Imag::Scmat4Imag(Imag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseImag(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseImag::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4LimagC : public SvbaseLimagC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4LimagC::Scmat4LimagC(const Limag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseLimagC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseLimagC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4Limag : public SvbaseLimag
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
...
inline Scmat4Limag::Scmat4Limag(Limag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseLimag(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}
...
{
	SvbaseLimag::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
class Scmat4QimagC : public SvbaseQimagC
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
	Scmat4QimagC();
	Scmat4QimagC(const Qimag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	...
	// resize() is a bad idea, don't try to create it!
	void reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	void set(const Qimag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	~Scmat4QimagC();
};

inline Scmat4QimagC::Scmat4QimagC() {}

inline Scmat4QimagC::Scmat4QimagC(const Qimag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseQimagC(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}


inline const Qimag &Scmat4QimagC::operator()(Long_I i, Long_I j, Long_I k, Long_I l) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1 || k < 0 || k >= m_N2 || l < 0 || l >= m_N3)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Long Scmat4QimagC::n0() const
{
	return m_N0;
}

inline Long Scmat4QimagC::n1() const
{
	return m_N1;
}

inline Long Scmat4QimagC::n2() const
{
	return m_N2;
}

inline Long Scmat4QimagC::n3() const
{
	return m_N3;
}

inline void Scmat4QimagC::reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
#ifdef SLS_CHECK_SHAPES
	if (N0*N1*N2*N3 != m_N)
		SLS_ERR("illegal reshape!");
...
inline void Scmat4QimagC::set(const Qimag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
	SvbaseQimagC::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}

inline Scmat4QimagC::~Scmat4QimagC() {}

typedef const Scmat4QimagC &Scmat4Qimag_I;


class Scmat4Qimag : public SvbaseQimag
{
protected:
	Long m_N0, m_N1, m_N2, m_N3;
public:
	Scmat4Qimag();
	Scmat4Qimag(Qimag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);

	operator const Scmat4QimagC &() const;
	operator Scmat4QimagC &();

	Qimag &operator()(Long_I i, Long_I j, Long_I k, Long_I l) const;
	...
	// resize() is a bad idea, don't try to create it!
	void reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	void set(Qimag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3);
	~Scmat4Qimag();
};

inline Scmat4Qimag::Scmat4Qimag() {}

inline Scmat4Qimag::Scmat4Qimag(Qimag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
	: SvbaseQimag(data, N0*N1*N2*N3), m_N0(N0), m_N1(N1), m_N2(N2), m_N3(N3) {}

inline Scmat4Qimag::operator const Scmat4QimagC &() const
{
	return reinterpret_cast<const Scmat4QimagC &>(*this);
}

inline Scmat4Qimag::operator Scmat4QimagC &()
{
	return reinterpret_cast<Scmat4QimagC &>(*this);
}

inline Qimag &Scmat4Qimag::operator()(Long_I i, Long_I j, Long_I k, Long_I l) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1 || k < 0 || k >= m_N2 || l < 0 || l >= m_N3)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Long Scmat4Qimag::n0() const
{
	return m_N0;
}

inline Long Scmat4Qimag::n1() const
{
	return m_N1;
}

inline Long Scmat4Qimag::n2() const
{
	return m_N2;
}

inline Long Scmat4Qimag::n3() const
{
	return m_N3;
}

inline void Scmat4Qimag::reshape(Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
#ifdef SLS_CHECK_SHAPES
	if (N0*N1*N2*N3 != m_N)
		SLS_ERR("illegal reshape!");
...
inline void Scmat4Qimag::set(Qimag *data, Long_I N0, Long_I N1, Long_I N2, Long_I N3)
{
	SvbaseQimag::set(data, N0*N1*N2*N3);
	m_N0 = N0; m_N1 = N1; m_N2 = N2; m_N3 = N3;
}
...
// use "const" so that it can be bind to a temporary e.g. copy(cut0(a), cut0(b))
typedef const Scmat4Qimag &Scmat4Qimag_O, &Scmat4Qimag_IO;
