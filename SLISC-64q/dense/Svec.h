...
public:
	SvecQdoubC() = default;
	explicit SvecQdoubC(Long_I N) : SvbaseQdoubC(N) {};
	SvecQdoubC(const Qdoub *data, Long_I N) : SvbaseQdoubC(data, N) {};
...
public:
	SvecQdoub() = default;
	explicit SvecQdoub(Long_I N) : SvbaseQdoub(N) {};
	SvecQdoub(Qdoub *data, Long_I N) : SvbaseQdoub(data, N) {};
...
public:
	SvecQcompC() = default;
	explicit SvecQcompC(Long_I N) : SvbaseQcompC(N) {};
	SvecQcompC(const Qcomp *data, Long_I N) : SvbaseQcompC(data, N) {};
...
public:
	SvecQcomp() = default;
	explicit SvecQcomp(Long_I N) : SvbaseQcomp(N) {};
	SvecQcomp(Qcomp *data, Long_I N) : SvbaseQcomp(data, N) {};
...
public:
	SvecQimagC() = default;
	explicit SvecQimagC(Long_I N) : SvbaseQimagC(N) {};
	SvecQimagC(const Qimag *data, Long_I N) : SvbaseQimagC(data, N) {};
...
public:
	SvecQimag() = default;
	explicit SvecQimag(Long_I N) : SvbaseQimag(N) {};
	SvecQimag(Qimag *data, Long_I N) : SvbaseQimag(data, N) {};
