...
public:
	...
	SvbaseQdoubC(const Qdoub *data, Long_I N); // unsafe
	const Qdoub* p() const;
	Long size() const;
...
public:
	...
	SvbaseQcompC(const Qcomp *data, Long_I N); // unsafe
	const Qcomp* p() const;
	Long size() const;
...
public:
	...
	SvecQdoubC(const Qdoub *data, Long_I N); // unsafe
...
public:
	...
	SvecQcompC(const Qcomp *data, Long_I N); // unsafe
