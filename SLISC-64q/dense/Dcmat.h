...
public:
	DcmatQdoubC();
	DcmatQdoubC(const Qdoub *p, Long_I N0, Long_I N1, Long_I lda);
	void set(const Qdoub *p, Long_I N0, Long_I N1, Long_I lda);
	void set(const DcmatQdoubC &sli);
...
inline DcmatQdoubC::DcmatQdoubC() {}

inline DcmatQdoubC::DcmatQdoubC(const Qdoub *p, Long_I N0, Long_I N1, Long_I lda)
	: m_p(p), m_N(N0*N1), m_N0(N0), m_N1(N1), m_lda(lda)
{}

inline void DcmatQdoubC::set(const Qdoub *p, Long_I N0, Long_I N1, Long_I lda)
{
	m_p = p; m_N0 = N0; m_N1 = N1; m_N = N0 * N1; m_lda = lda;
}

inline void DcmatQdoubC::set(const DcmatQdoubC &sli)
{
	m_p = sli.m_p; m_N = sli.m_N; m_N0 = sli.m_N0; m_N1 = sli.m_N1; m_lda = sli.m_lda;
}


inline const Qdoub &DcmatQdoubC::operator[](Long_I i) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N)
		SLS_ERR("Matrix subscript out of bounds");
...
inline const Qdoub &DcmatQdoubC::operator()(Long_I i, Long_I j) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Long DcmatQdoubC::n0() const
{
	return m_N0;
}

inline Long DcmatQdoubC::n1() const
{
	return m_N1;
}

inline Long DcmatQdoubC::lda() const
{
	return m_lda;
}

inline Long DcmatQdoubC::size() const
{
	return m_N;
}

inline const Qdoub * DcmatQdoubC::p() const
{
	return m_p;
}

typedef const DcmatQdoubC &DcmatQdoub_I;
...
inline DcmatQdoub::operator DcmatQdoubC() const
{
	return *((DcmatQdoubC *)this);
}
...
public:
	DcmatQcompC();
	DcmatQcompC(const Qcomp *p, Long_I N0, Long_I N1, Long_I lda);
	void set(const Qcomp *p, Long_I N0, Long_I N1, Long_I lda);
	void set(const DcmatQcompC &sli);
...
inline DcmatQcompC::DcmatQcompC() {}

inline DcmatQcompC::DcmatQcompC(const Qcomp *p, Long_I N0, Long_I N1, Long_I lda)
	: m_p(p), m_N(N0*N1), m_N0(N0), m_N1(N1), m_lda(lda)
{}

inline void DcmatQcompC::set(const Qcomp *p, Long_I N0, Long_I N1, Long_I lda)
{
	m_p = p; m_N0 = N0; m_N1 = N1; m_N = N0 * N1; m_lda = lda;
}

inline void DcmatQcompC::set(const DcmatQcompC &sli)
{
	m_p = sli.m_p; m_N = sli.m_N; m_N0 = sli.m_N0; m_N1 = sli.m_N1; m_lda = sli.m_lda;
}


inline const Qcomp &DcmatQcompC::operator[](Long_I i) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N)
		SLS_ERR("Matrix subscript out of bounds");
...
inline const Qcomp &DcmatQcompC::operator()(Long_I i, Long_I j) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Long DcmatQcompC::n0() const
{
	return m_N0;
}

inline Long DcmatQcompC::n1() const
{
	return m_N1;
}

inline Long DcmatQcompC::lda() const
{
	return m_lda;
}

inline Long DcmatQcompC::size() const
{
	return m_N;
}

inline const Qcomp * DcmatQcompC::p() const
{
	return m_p;
}

typedef const DcmatQcompC &DcmatQcomp_I;
...
inline DcmatQcomp::operator DcmatQcompC() const
{
	return *((DcmatQcompC *)this);
}
...
public:
	DcmatQimagC();
	DcmatQimagC(const Qimag *p, Long_I N0, Long_I N1, Long_I lda);
	void set(const Qimag *p, Long_I N0, Long_I N1, Long_I lda);
	void set(const DcmatQimagC &sli);
...
inline DcmatQimagC::DcmatQimagC() {}

inline DcmatQimagC::DcmatQimagC(const Qimag *p, Long_I N0, Long_I N1, Long_I lda)
	: m_p(p), m_N(N0*N1), m_N0(N0), m_N1(N1), m_lda(lda)
{}

inline void DcmatQimagC::set(const Qimag *p, Long_I N0, Long_I N1, Long_I lda)
{
	m_p = p; m_N0 = N0; m_N1 = N1; m_N = N0 * N1; m_lda = lda;
}

inline void DcmatQimagC::set(const DcmatQimagC &sli)
{
	m_p = sli.m_p; m_N = sli.m_N; m_N0 = sli.m_N0; m_N1 = sli.m_N1; m_lda = sli.m_lda;
}


inline const Qimag &DcmatQimagC::operator[](Long_I i) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N)
		SLS_ERR("Matrix subscript out of bounds");
...
inline const Qimag &DcmatQimagC::operator()(Long_I i, Long_I j) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Long DcmatQimagC::n0() const
{
	return m_N0;
}

inline Long DcmatQimagC::n1() const
{
	return m_N1;
}

inline Long DcmatQimagC::lda() const
{
	return m_lda;
}

inline Long DcmatQimagC::size() const
{
	return m_N;
}

inline const Qimag * DcmatQimagC::p() const
{
	return m_p;
}

typedef const DcmatQimagC &DcmatQimag_I;
...
public:
	DcmatQimag();
	DcmatQimag(Qimag *p, Long_I N0, Long_I N1, Long_I lda);
	void set(Qimag *p, Long_I N0, Long_I N1, Long_I lda);
	void set(const DcmatQimag &sli);

	operator DcmatQimagC() const;
	Qimag& operator[](Long_I i);
	Qimag& operator()(Long_I i, Long_I j);
...
inline DcmatQimag::DcmatQimag() {}

inline DcmatQimag::DcmatQimag(Qimag *p, Long_I N0, Long_I N1, Long_I lda)
	: m_p(p), m_N(N0*N1), m_N0(N0), m_N1(N1), m_lda(lda)
{}

inline void DcmatQimag::set(Qimag *p, Long_I N0, Long_I N1, Long_I lda)
{
	m_p = p; m_N0 = N0; m_N1 = N1; m_N = N0 * N1; m_lda = lda;
}

inline void DcmatQimag::set(const DcmatQimag &sli)
{
	m_p = sli.m_p; m_N = sli.m_N; m_N0 = sli.m_N0; m_N1 = sli.m_N1; m_lda = sli.m_lda;
}

inline DcmatQimag::operator DcmatQimagC() const
{
	return *((DcmatQimagC *)this);
}

inline Qimag &DcmatQimag::operator[](Long_I i)
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Qimag &DcmatQimag::operator()(Long_I i, Long_I j)
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Qimag &DcmatQimag::operator[](Long_I i) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Qimag &DcmatQimag::operator()(Long_I i, Long_I j) const
{
#ifdef SLS_CHECK_BOUNDS
	if (i < 0 || i >= m_N0 || j < 0 || j >= m_N1)
		SLS_ERR("Matrix subscript out of bounds");
...
inline Long DcmatQimag::n0() const
{
	return m_N0;
}

inline Long DcmatQimag::n1() const
{
	return m_N1;
}

inline Long DcmatQimag::lda() const
{
	return m_lda;
}

inline Long DcmatQimag::size() const
{
	return m_N;
}

inline Qimag * DcmatQimag::p() const
{
	return m_p;
}

// use "const" so that it can be bind to a temporary e.g. copy(cut0(a), cut0(b))
typedef const DcmatQimag &DcmatQimag_O, &DcmatQimag_IO;
