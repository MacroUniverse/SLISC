...
public:
	...
	VecQdoub(VecQdoub &&rhs); // move constructor
...
inline VecQdoub::VecQdoub(VecQdoub &&rhs) : Base(move(rhs))
{
#ifdef SLS_NO_CPY_CONSTRUCTOR
	SLS_ERR("move constructor forbidden!");
#endif
...
public:
	...
	VecQcomp(VecQcomp &&rhs); // move constructor
...
inline VecQcomp::VecQcomp(VecQcomp &&rhs) : Base(move(rhs))
{
#ifdef SLS_NO_CPY_CONSTRUCTOR
	SLS_ERR("move constructor forbidden!");
#endif
...
public:
	...
	VecQimag(VecQimag &&rhs); // move constructor
	VecQimag &operator=(const VecQimag &); // copy asignment
	VecQimag &operator=(VecQimag &&); // move asignment
};

inline VecQimag::VecQimag(Long_I N) : Base(N) {}

inline VecQimag::VecQimag(const VecQimag &rhs) : Base(rhs)
{
#ifdef SLS_NO_CPY_CONSTRUCTOR
	SLS_ERR("copy constructor forbidden!");
#endif
...
inline VecQimag::VecQimag(VecQimag &&rhs) : Base(move(rhs))
{
#ifdef SLS_NO_CPY_CONSTRUCTOR
	SLS_ERR("move constructor forbidden!");
#endif
