...
public:
	using VbaseQdoub::VbaseQdoub;
	VecQdoub() = default;
	explicit VecQdoub(Long_I N) : Base(N) {}
	VecQdoub(const VecQdoub &rhs) = default;
	VecQdoub(VecQdoub &&) = default;
	VecQdoub &operator=(const VecQdoub &) = default;
	VecQdoub &operator=(VecQdoub &&) = default;
...
public:
	using VbaseQcomp::VbaseQcomp;
	VecQcomp() = default;
	explicit VecQcomp(Long_I N) : Base(N) {}
	VecQcomp(const VecQcomp &rhs) = default;
	VecQcomp(VecQcomp &&) = default;
	VecQcomp &operator=(const VecQcomp &) = default;
	VecQcomp &operator=(VecQcomp &&) = default;
...
class VecQimag : public VbaseQimag {
protected:
	typedef VbaseQimag Base;
public:
	using VbaseQimag::VbaseQimag;
	VecQimag() = default;
	explicit VecQimag(Long_I N) : Base(N) {}
	VecQimag(const VecQimag &rhs) = default;
	VecQimag(VecQimag &&) = default;
	VecQimag &operator=(const VecQimag &) = default;
	VecQimag &operator=(VecQimag &&) = default;
