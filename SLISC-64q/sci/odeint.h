...
const Doub Dopr853_constants::b10 = -1.52160949662516078556178806805e-1;
const Doub Dopr853_constants::b11 =  2.01365400804030348374776537501e-1;
const Doub Dopr853_constants::b12 =  4.47106157277725905176885569043e-2;

const Doub Dopr853_constants::bhh1 = 0.244094488188976377952755905512e+00;
const Doub Dopr853_constants::bhh2 = 0.733846688281611857341361741547e+00;
const Doub Dopr853_constants::bhh3 = 0.220588235294117647058823529412e-01;

const Doub Dopr853_constants::er1  =  0.1312004499419488073250102996e-01;
const Doub Dopr853_constants::er6  = -0.1225156446376204440720569753e+01;
const Doub Dopr853_constants::er7  = -0.4957589496572501915214079952e+00;
const Doub Dopr853_constants::er8  =  0.1664377182454986536961530415e+01;
const Doub Dopr853_constants::er9  = -0.3503288487499736816886487290e+00;
const Doub Dopr853_constants::er10 =  0.3341791187130174790297318841e+00;
const Doub Dopr853_constants::er11 =  0.8192320648511571246570742613e-01;
const Doub Dopr853_constants::er12 = -0.2235530786388629525884427845e-01;

const Doub Dopr853_constants::a21 =    5.26001519587677318785587544488e-2;
const Doub Dopr853_constants::a31 =    1.97250569845378994544595329183e-2;
const Doub Dopr853_constants::a32 =    5.91751709536136983633785987549e-2;
const Doub Dopr853_constants::a41 =    2.95875854768068491816892993775e-2;
const Doub Dopr853_constants::a43 =    8.87627564304205475450678981324e-2;
const Doub Dopr853_constants::a51 =    2.41365134159266685502369798665e-1;
const Doub Dopr853_constants::a53 =   -8.84549479328286085344864962717e-1;
const Doub Dopr853_constants::a54 =    9.24834003261792003115737966543e-1;
const Doub Dopr853_constants::a61 =    3.7037037037037037037037037037e-2;
const Doub Dopr853_constants::a64 =    1.70828608729473871279604482173e-1;
const Doub Dopr853_constants::a65 =    1.25467687566822425016691814123e-1;
const Doub Dopr853_constants::a71 =    3.7109375e-2;
const Doub Dopr853_constants::a74 =    1.70252211019544039314978060272e-1;
const Doub Dopr853_constants::a75 =    6.02165389804559606850219397283e-2;
const Doub Dopr853_constants::a76 =   -1.7578125e-2;

const Doub Dopr853_constants::a81 =    3.70920001185047927108779319836e-2;
const Doub Dopr853_constants::a84 =    1.70383925712239993810214054705e-1;
const Doub Dopr853_constants::a85 =    1.07262030446373284651809199168e-1;
const Doub Dopr853_constants::a86 =   -1.53194377486244017527936158236e-2;
const Doub Dopr853_constants::a87 =    8.27378916381402288758473766002e-3;
const Doub Dopr853_constants::a91 =    6.24110958716075717114429577812e-1;
const Doub Dopr853_constants::a94 =   -3.36089262944694129406857109825e0;
const Doub Dopr853_constants::a95 =   -8.68219346841726006818189891453e-1;
const Doub Dopr853_constants::a96 =    2.75920996994467083049415600797e1;
const Doub Dopr853_constants::a97 =    2.01540675504778934086186788979e1;
const Doub Dopr853_constants::a98 =   -4.34898841810699588477366255144e1;
const Doub Dopr853_constants::a101 =   4.77662536438264365890433908527e-1;
const Doub Dopr853_constants::a104 =  -2.48811461997166764192642586468e0;
const Doub Dopr853_constants::a105 =  -5.90290826836842996371446475743e-1;
const Doub Dopr853_constants::a106 =   2.12300514481811942347288949897e1;
const Doub Dopr853_constants::a107 =   1.52792336328824235832596922938e1;
const Doub Dopr853_constants::a108 =  -3.32882109689848629194453265587e1;
const Doub Dopr853_constants::a109 =  -2.03312017085086261358222928593e-2;

const Doub Dopr853_constants::a111 =  -9.3714243008598732571704021658e-1;
const Doub Dopr853_constants::a114 =   5.18637242884406370830023853209e0;
const Doub Dopr853_constants::a115 =   1.09143734899672957818500254654e0;
const Doub Dopr853_constants::a116 =  -8.14978701074692612513997267357e0;
const Doub Dopr853_constants::a117 =  -1.85200656599969598641566180701e1;
const Doub Dopr853_constants::a118 =   2.27394870993505042818970056734e1;
const Doub Dopr853_constants::a119 =   2.49360555267965238987089396762e0;
const Doub Dopr853_constants::a1110 = -3.0467644718982195003823669022e0;
const Doub Dopr853_constants::a121 =   2.27331014751653820792359768449e0;
const Doub Dopr853_constants::a124 =  -1.05344954667372501984066689879e1;
...
const Doub Dopr853_constants::a147 =  2.53500210216624811088794765333e-1;
const Doub Dopr853_constants::a148 = -2.46239037470802489917441475441e-1;
const Doub Dopr853_constants::a149 = -1.24191423263816360469010140626e-1;
const Doub Dopr853_constants::a1410 =  1.5329179827876569731206322685e-1;
const Doub Dopr853_constants::a1411 =  8.20105229563468988491666602057e-3;
...
const Doub Dopr853_constants::a1614 =  2.9475147891527723389556272149e0;
...
const Doub Dopr853_constants::d410 = -0.87139158377797299206789907490e+00;
