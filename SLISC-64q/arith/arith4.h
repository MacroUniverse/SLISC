...
inline void operator+=(SvbaseQdoub_IO v, Qdoub_I s)
{ add_eq_vs(&v[0], s, v.size()); }
...
inline void operator+=(SvbaseQcomp_IO v, Qdoub_I s)
{ add_eq_vs(&v[0], s, v.size()); }
...
inline void operator+=(SvbaseQdoub_O v, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	add_eq_vv(&v[0], &v1[0], v1.size());
}
...
inline void operator+=(SvbaseQcomp_O v, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	add_eq_vv(&v[0], &v1[0], v1.size());
}
...
inline void operator+=(SvbaseQcomp_O v, SvbaseQcomp_I v1)
{
	assert_same_shape1(v, v1);
	add_eq_vv(&v[0], &v1[0], v1.size());
}
...
inline void operator+=(DvecQdoub_O v, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	for (Long i = 0; i < v.size(); ++i)
		v[i] += v1[i];
...
inline void operator+=(DvecQcomp_O v, SvbaseQcomp_I v1)
{
	assert_same_shape1(v, v1);
	for (Long i = 0; i < v.size(); ++i)
		v[i] += v1[i];
...
inline void operator+=(DvecQcomp_O v, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	for (Long i = 0; i < v.size(); ++i)
		v[i] += v1[i];
...
inline void add(SvbaseQdoub_O v, SvbaseQdoub_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	add_vvs(&v[0], &v1[0], s, v1.size());
}

inline void add(SvbaseQdoub_O v, Qdoub_I s, SvbaseQdoub_I v1)
{ add(v, v1, s); }

inline void sub(SvbaseQdoub_O v, SvbaseQdoub_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	sub_vvs(&v[0], &v1[0], s, v1.size());
}

inline void sub(SvbaseQdoub_O v, Qdoub_I s, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	sub_vsv(&v[0], s, &v1[0], v1.size());
}

inline void times(SvbaseQdoub_O v, SvbaseQdoub_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	times_vvs(&v[0], &v1[0], s, v1.size());
}

inline void times(SvbaseQdoub_O v, Qdoub_I s, SvbaseQdoub_I v1)
{ times(v, v1, s); }

inline void div(SvbaseQdoub_O v, SvbaseQdoub_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	div_vvs(&v[0], &v1[0], s, v1.size());
}

inline void div(SvbaseQdoub_O v, Qdoub_I s, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	div_vsv(&v[0], s, &v1[0], v1.size());
}
...
inline void add(SvbaseQcomp_O v, SvbaseQdoub_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	add_vvs(&v[0], &v1[0], s, v1.size());
}

inline void add(SvbaseQcomp_O v, Qdoub_I s, SvbaseQdoub_I v1)
{ add(v, v1, s); }

inline void sub(SvbaseQcomp_O v, SvbaseQdoub_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	sub_vvs(&v[0], &v1[0], s, v1.size());
}

inline void sub(SvbaseQcomp_O v, Qdoub_I s, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	sub_vsv(&v[0], s, &v1[0], v1.size());
}

inline void times(SvbaseQcomp_O v, SvbaseQdoub_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	times_vvs(&v[0], &v1[0], s, v1.size());
}

inline void times(SvbaseQcomp_O v, Qdoub_I s, SvbaseQdoub_I v1)
{ times(v, v1, s); }

inline void div(SvbaseQcomp_O v, SvbaseQdoub_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	div_vvs(&v[0], &v1[0], s, v1.size());
}

inline void div(SvbaseQcomp_O v, Qdoub_I s, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	div_vsv(&v[0], s, &v1[0], v1.size());
}

inline void add(SvbaseQcomp_O v, SvbaseQdoub_I v1, Qimag_I s)
{
	assert_same_shape1(v, v1);
	add_vvs(&v[0], &v1[0], s, v1.size());
}

inline void add(SvbaseQcomp_O v, Qimag_I s, SvbaseQdoub_I v1)
{ add(v, v1, s); }

inline void sub(SvbaseQcomp_O v, SvbaseQdoub_I v1, Qimag_I s)
{
	assert_same_shape1(v, v1);
	sub_vvs(&v[0], &v1[0], s, v1.size());
}

inline void sub(SvbaseQcomp_O v, Qimag_I s, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	sub_vsv(&v[0], s, &v1[0], v1.size());
}

inline void times(SvbaseQcomp_O v, SvbaseQdoub_I v1, Qimag_I s)
{
	assert_same_shape1(v, v1);
	times_vvs(&v[0], &v1[0], s, v1.size());
}

inline void times(SvbaseQcomp_O v, Qimag_I s, SvbaseQdoub_I v1)
{ times(v, v1, s); }

inline void div(SvbaseQcomp_O v, SvbaseQdoub_I v1, Qimag_I s)
{
	assert_same_shape1(v, v1);
	div_vvs(&v[0], &v1[0], s, v1.size());
}

inline void div(SvbaseQcomp_O v, Qimag_I s, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	div_vsv(&v[0], s, &v1[0], v1.size());
}

inline void add(SvbaseQcomp_O v, SvbaseQcomp_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	add_vvs(&v[0], &v1[0], s, v1.size());
}

inline void add(SvbaseQcomp_O v, Qdoub_I s, SvbaseQcomp_I v1)
{ add(v, v1, s); }

inline void sub(SvbaseQcomp_O v, SvbaseQcomp_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	sub_vvs(&v[0], &v1[0], s, v1.size());
}

inline void sub(SvbaseQcomp_O v, Qdoub_I s, SvbaseQcomp_I v1)
{
	assert_same_shape1(v, v1);
	sub_vsv(&v[0], s, &v1[0], v1.size());
}

inline void times(SvbaseQcomp_O v, SvbaseQcomp_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	times_vvs(&v[0], &v1[0], s, v1.size());
}

inline void times(SvbaseQcomp_O v, Qdoub_I s, SvbaseQcomp_I v1)
{ times(v, v1, s); }

inline void div(SvbaseQcomp_O v, SvbaseQcomp_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	div_vvs(&v[0], &v1[0], s, v1.size());
}

inline void div(SvbaseQcomp_O v, Qdoub_I s, SvbaseQcomp_I v1)
{
	assert_same_shape1(v, v1);
	div_vsv(&v[0], s, &v1[0], v1.size());
}

inline void add(SvbaseQcomp_O v, SvbaseQcomp_I v1, Qcomp_I s)
{
	assert_same_shape1(v, v1);
	add_vvs(&v[0], &v1[0], s, v1.size());
}

inline void add(SvbaseQcomp_O v, Qcomp_I s, SvbaseQcomp_I v1)
{ add(v, v1, s); }

inline void sub(SvbaseQcomp_O v, SvbaseQcomp_I v1, Qcomp_I s)
{
	assert_same_shape1(v, v1);
	sub_vvs(&v[0], &v1[0], s, v1.size());
}

inline void sub(SvbaseQcomp_O v, Qcomp_I s, SvbaseQcomp_I v1)
{
	assert_same_shape1(v, v1);
	sub_vsv(&v[0], s, &v1[0], v1.size());
}

inline void times(SvbaseQcomp_O v, SvbaseQcomp_I v1, Qcomp_I s)
{
	assert_same_shape1(v, v1);
	times_vvs(&v[0], &v1[0], s, v1.size());
}

inline void times(SvbaseQcomp_O v, Qcomp_I s, SvbaseQcomp_I v1)
{ times(v, v1, s); }

inline void div(SvbaseQcomp_O v, SvbaseQcomp_I v1, Qcomp_I s)
{
	assert_same_shape1(v, v1);
	div_vvs(&v[0], &v1[0], s, v1.size());
}

inline void div(SvbaseQcomp_O v, Qcomp_I s, SvbaseQcomp_I v1)
{
	assert_same_shape1(v, v1);
	div_vsv(&v[0], s, &v1[0], v1.size());
}
...
inline void add(SvecQcomp_O v, SvbaseQcomp_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	add_vvs(&v[0], &v1[0], s, v1.size());
}

inline void add(SvecQcomp_O v, Qdoub_I s, SvbaseQcomp_I v1)
{ add(v, v1, s); }

inline void sub(SvecQcomp_O v, SvbaseQcomp_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	sub_vvs(&v[0], &v1[0], s, v1.size());
}

inline void sub(SvecQcomp_O v, Qdoub_I s, SvbaseQcomp_I v1)
{
	assert_same_shape1(v, v1);
	sub_vsv(&v[0], s, &v1[0], v1.size());
}

inline void times(SvecQcomp_O v, SvbaseQcomp_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	times_vvs(&v[0], &v1[0], s, v1.size());
}

inline void times(SvecQcomp_O v, Qdoub_I s, SvbaseQcomp_I v1)
{ times(v, v1, s); }

inline void div(SvecQcomp_O v, SvbaseQcomp_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	div_vvs(&v[0], &v1[0], s, v1.size());
}

inline void div(SvecQcomp_O v, Qdoub_I s, SvbaseQcomp_I v1)
{
	assert_same_shape1(v, v1);
	div_vsv(&v[0], s, &v1[0], v1.size());
}
...
inline void add(SvbaseQdoub_O v, SvbaseQdoub_I v1, SvbaseQdoub_I v2)
{
	assert_same_shape1(v, v1, v2);
	add_vvv(&v[0], &v1[0], &v2[0], v.size());
}

inline void sub(SvbaseQdoub_O v, SvbaseQdoub_I v1, SvbaseQdoub_I v2)
{
	assert_same_shape1(v, v1, v2);
	sub_vvv(&v[0], &v1[0], &v2[0], v.size());
}

inline void times(SvbaseQdoub_O v, SvbaseQdoub_I v1, SvbaseQdoub_I v2)
{
	assert_same_shape1(v, v1, v2);
	times_vvv(&v[0], &v1[0], &v2[0], v.size());
}

inline void div(SvbaseQdoub_O v, SvbaseQdoub_I v1, SvbaseQdoub_I v2)
{
	assert_same_shape1(v, v1, v2);
	div_vvv(&v[0], &v1[0], &v2[0], v.size());
}
...
inline void add(SvbaseQcomp_O v, SvbaseQcomp_I v1, SvbaseQcomp_I v2)
{
	assert_same_shape1(v, v1, v2);
	add_vvv(&v[0], &v1[0], &v2[0], v.size());
}

inline void sub(SvbaseQcomp_O v, SvbaseQcomp_I v1, SvbaseQcomp_I v2)
{
	assert_same_shape1(v, v1, v2);
	sub_vvv(&v[0], &v1[0], &v2[0], v.size());
}

inline void times(SvbaseQcomp_O v, SvbaseQcomp_I v1, SvbaseQcomp_I v2)
{
	assert_same_shape1(v, v1, v2);
	times_vvv(&v[0], &v1[0], &v2[0], v.size());
}

inline void div(SvbaseQcomp_O v, SvbaseQcomp_I v1, SvbaseQcomp_I v2)
{
	assert_same_shape1(v, v1, v2);
	div_vvv(&v[0], &v1[0], &v2[0], v.size());
}
...
inline void add(DvecQcomp_O v, SvbaseQcomp_I v1, DvecQcomp_I v2)
{
	assert_same_shape1(v, v1, v2);
	add_vvv(v.p(), v1.p(), v2.p(), v.size(), v.step(), 1, v2.step());
}

inline void sub(DvecQcomp_O v, SvbaseQcomp_I v1, DvecQcomp_I v2)
{
	assert_same_shape1(v, v1, v2);
	sub_vvv(v.p(), v1.p(), v2.p(), v.size(), v.step(), 1, v2.step());
}

inline void times(DvecQcomp_O v, SvbaseQcomp_I v1, DvecQcomp_I v2)
{
	assert_same_shape1(v, v1, v2);
	sub_vvv(v.p(), v1.p(), v2.p(), v.size(), v.step(), 1, v2.step());
}

inline void div(DvecQcomp_O v, SvbaseQcomp_I v1, DvecQcomp_I v2)
{
	assert_same_shape1(v, v1, v2);
	div_vvv(v.p(), v1.p(), v2.p(), v.size(), v.step(), 1, v2.step());
}
...
inline void neg(SvbaseQdoub_O v, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	neg_vv(v.p(), v1.p(), v1.size());
}
...
inline void neg(SvbaseQcomp_O v, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	neg_vv(v.p(), v1.p(), v1.size());
}

inline void neg(SvbaseQcomp_O v, SvbaseQcomp_I v1)
{
	assert_same_shape1(v, v1);
	neg_vv(v.p(), v1.p(), v1.size());
}
