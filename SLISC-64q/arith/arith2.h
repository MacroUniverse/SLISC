...
inline void real(SvbaseQdoub_O v, SvbaseQcomp_I v1)
{
	assert_same_shape1(v, v1);
	real_vv(v.p(), v1.p(), v1.size());
}

inline void imag(SvbaseQdoub_O v, SvbaseQcomp_I v1)
{
	assert_same_shape1(v, v1);
	imag_vv(v.p(), v1.p(), v1.size());
}
...
inline void abs(SvbaseQdoub_IO v)
{ abs_v(v.p(), v.size()); }

inline void abs(SvbaseComp_IO v)
{ abs_v(v.p(), v.size()); }

inline void abs(SvbaseQcomp_IO v)
{ abs_v(v.p(), v.size()); }
...
inline void abs(SvbaseQdoub_O v, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	abs_vv(v.p(), v1.p(), v1.size());
}
...
inline void abs(SvbaseQdoub_O v, SvbaseQcomp_I v1)
{
	assert_same_shape1(v, v1);
	abs_vv(v.p(), v1.p(), v1.size());
}
...
inline void linspace(SvbaseQdoub_O v, Qdoub_I first, Qdoub_I last)
{ linspace_vss(v.p(), first, last, v.size()); }

inline void linspace(SvbaseComp_O v, Comp_I first, Comp_I last)
{ linspace_vss(v.p(), first, last, v.size()); }

inline void linspace(SvbaseQcomp_O v, Qcomp_I first, Qcomp_I last)
{ linspace_vss(v.p(), first, last, v.size()); }
...
inline void pow(SvbaseQdoub_O v, SvbaseQdoub_I v1, Int_I s)
{
	assert_same_shape1(v, v1);
	pow_vvs(v.p(), v1.p(), s, v1.size());
}
...
inline void pow(SvbaseQdoub_O v, SvbaseQdoub_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	pow_vvs(v.p(), v1.p(), s, v1.size());
}
...
inline void pow(SvbaseQcomp_O v, SvbaseQdoub_I v1, Qcomp_I s)
{
	assert_same_shape1(v, v1);
	pow_vvs(v.p(), v1.p(), s, v1.size());
}
...
inline void pow(SvbaseQcomp_O v, SvbaseQcomp_I v1, Qdoub_I s)
{
	assert_same_shape1(v, v1);
	pow_vvs(v.p(), v1.p(), s, v1.size());
}
...
inline void pow(SvbaseQcomp_O v, SvbaseQcomp_I v1, Qcomp_I s)
{
	assert_same_shape1(v, v1);
	pow_vvs(v.p(), v1.p(), s, v1.size());
}
...
inline Qdoub dot(SvbaseQdoub_I v1, SvbaseQdoub_I v2)
{
	assert_same_shape1(v1, v2);
	return dot_vv(v1.p(), v2.p(), v2.size());
}

inline Qcomp dot(SvbaseQdoub_I v1, SvbaseQcomp_I v2)
{
	assert_same_shape1(v1, v2);
	return dot_vv(v1.p(), v2.p(), v2.size());
}
...
inline Qcomp dot(SvbaseQcomp_I v1, SvbaseQdoub_I v2)
{
	assert_same_shape1(v1, v2);
	return dot_vv(v1.p(), v2.p(), v2.size());
}

inline Qcomp dot(SvbaseQcomp_I v1, SvbaseQcomp_I v2)
{
	assert_same_shape1(v1, v2);
	return dot_vv(v1.p(), v2.p(), v2.size());
}
...
inline Qcomp dot(DvecQcomp_I v1, SvbaseQdoub_I v2)
{
	assert_same_shape1(v1, v2);
	Qcomp sum = 0;
	for (Long i = 0; i < v1.size(); ++i)
...
inline Doub dot_real_par(DcmatComp_I v1, DcmatComp_I v2)
{
...
#pragma omp parallel for reduction(+:sum2)
	for (Long j = 0; j < v1.n1(); ++j) {
		Doub sum = 0;
		const Comp *p1 = &v1(0,j);
		const Comp *p2 = &v2(0,j);
		for (Long i = 0; i < v1.n0(); ++i)
...
inline void cumsum(SvbaseQdoub_O v, SvbaseQdoub_I v1)
{
	assert_same_shape1(v, v1);
	cumsum_vv(v.p(), v1.p(), v1.size());
}
