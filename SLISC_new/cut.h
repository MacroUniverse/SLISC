...
inline DcmatChar cut(CmatChar_IO v, Long_I start1, Long_I N1, Long_I start2, Long_I N2)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() ||
        ...
        SLS_ERR("index out of bound!");
#endif
    DcmatChar sli(&v(start1, start2), N1, N2, v.n0());
    return sli;
}
    ...
    Long_I start1, Long_I N1, Long_I start2, Long_I N2)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() ||
        ...
        SLS_ERR("index out of bound!");
#endif
    DcmatChar_c sli(&v(start1, start2), N1, N2, v.n0());
    return sli;
}
inline ScmatChar cut(CmatChar_IO v, Long_I start2, Long_I N2)
{
    ...
    if (start2 < 0 || start2 + N2 > v.n1())
        SLS_ERR("index out of bound!");
#endif
    ScmatChar sli(&v(0, start2), v.n0(), N2);
    return sli;
}
...
inline ScmatChar_c cut(CmatChar_I v, Long_I start2, Long_I N2)
{
    ...
    if (start2 < 0 || start2 + N2 > v.n1())
        SLS_ERR("index out of bound!");
#endif
    ScmatChar_c sli(&v(0, start2), v.n0(), N2);
    return sli;
}
...
inline DcmatFloat cut(CmatFloat_IO v, Long_I start1, Long_I N1, Long_I start2, Long_I N2)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() ||
        ...
        SLS_ERR("index out of bound!");
#endif
    DcmatFloat sli(&v(start1, start2), N1, N2, v.n0());
    return sli;
}
    ...
    Long_I start1, Long_I N1, Long_I start2, Long_I N2)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() ||
        ...
        SLS_ERR("index out of bound!");
#endif
    DcmatFloat_c sli(&v(start1, start2), N1, N2, v.n0());
    return sli;
}
inline ScmatFloat cut(CmatFloat_IO v, Long_I start2, Long_I N2)
{
    ...
    if (start2 < 0 || start2 + N2 > v.n1())
        SLS_ERR("index out of bound!");
#endif
    ScmatFloat sli(&v(0, start2), v.n0(), N2);
    return sli;
}
...
inline ScmatFloat_c cut(CmatFloat_I v, Long_I start2, Long_I N2)
{
    ...
    if (start2 < 0 || start2 + N2 > v.n1())
        SLS_ERR("index out of bound!");
#endif
    ScmatFloat_c sli(&v(0, start2), v.n0(), N2);
    return sli;
}
...
inline DcmatLdoub cut(CmatLdoub_IO v, Long_I start1, Long_I N1, Long_I start2, Long_I N2)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() ||
        ...
        SLS_ERR("index out of bound!");
#endif
    DcmatLdoub sli(&v(start1, start2), N1, N2, v.n0());
    return sli;
}
    ...
    Long_I start1, Long_I N1, Long_I start2, Long_I N2)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() ||
        ...
        SLS_ERR("index out of bound!");
#endif
    DcmatLdoub_c sli(&v(start1, start2), N1, N2, v.n0());
    return sli;
}
inline ScmatLdoub cut(CmatLdoub_IO v, Long_I start2, Long_I N2)
{
    ...
    if (start2 < 0 || start2 + N2 > v.n1())
        SLS_ERR("index out of bound!");
#endif
    ScmatLdoub sli(&v(0, start2), v.n0(), N2);
    return sli;
}
...
inline ScmatLdoub_c cut(CmatLdoub_I v, Long_I start2, Long_I N2)
{
    ...
    if (start2 < 0 || start2 + N2 > v.n1())
        SLS_ERR("index out of bound!");
#endif
    ScmatLdoub_c sli(&v(0, start2), v.n0(), N2);
    return sli;
}
...
inline DcmatFcomp cut(CmatFcomp_IO v, Long_I start1, Long_I N1, Long_I start2, Long_I N2)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() ||
        ...
        SLS_ERR("index out of bound!");
#endif
    DcmatFcomp sli(&v(start1, start2), N1, N2, v.n0());
    return sli;
}
    ...
    Long_I start1, Long_I N1, Long_I start2, Long_I N2)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() ||
        ...
        SLS_ERR("index out of bound!");
#endif
    DcmatFcomp_c sli(&v(start1, start2), N1, N2, v.n0());
    return sli;
}
inline ScmatFcomp cut(CmatFcomp_IO v, Long_I start2, Long_I N2)
{
    ...
    if (start2 < 0 || start2 + N2 > v.n1())
        SLS_ERR("index out of bound!");
#endif
    ScmatFcomp sli(&v(0, start2), v.n0(), N2);
    return sli;
}
...
inline ScmatFcomp_c cut(CmatFcomp_I v, Long_I start2, Long_I N2)
{
    ...
    if (start2 < 0 || start2 + N2 > v.n1())
        SLS_ERR("index out of bound!");
#endif
    ScmatFcomp_c sli(&v(0, start2), v.n0(), N2);
    return sli;
}
...
inline DcmatLcomp cut(CmatLcomp_IO v, Long_I start1, Long_I N1, Long_I start2, Long_I N2)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() ||
        ...
        SLS_ERR("index out of bound!");
#endif
    DcmatLcomp sli(&v(start1, start2), N1, N2, v.n0());
    return sli;
}
    ...
    Long_I start1, Long_I N1, Long_I start2, Long_I N2)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() ||
        ...
        SLS_ERR("index out of bound!");
#endif
    DcmatLcomp_c sli(&v(start1, start2), N1, N2, v.n0());
    return sli;
}
inline ScmatLcomp cut(CmatLcomp_IO v, Long_I start2, Long_I N2)
{
    ...
    if (start2 < 0 || start2 + N2 > v.n1())
        SLS_ERR("index out of bound!");
#endif
    ScmatLcomp sli(&v(0, start2), v.n0(), N2);
    return sli;
}
...
inline ScmatLcomp_c cut(CmatLcomp_I v, Long_I start2, Long_I N2)
{
    ...
    if (start2 < 0 || start2 + N2 > v.n1())
        SLS_ERR("index out of bound!");
#endif
    ScmatLcomp_c sli(&v(0, start2), v.n0(), N2);
    return sli;
}
...
inline Jcmat3Char cut(Cmat3Char_IO v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Char sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline Jcmat3Char_c cut(Cmat3Char_I v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Char_c sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline Jcmat3Int cut(Cmat3Int_IO v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Int sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline Jcmat3Int_c cut(Cmat3Int_I v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Int_c sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline Jcmat3Llong cut(Cmat3Llong_IO v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Llong sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline Jcmat3Llong_c cut(Cmat3Llong_I v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Llong_c sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline Jcmat3Float cut(Cmat3Float_IO v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Float sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline Jcmat3Float_c cut(Cmat3Float_I v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Float_c sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline Jcmat3Ldoub cut(Cmat3Ldoub_IO v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Ldoub sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline Jcmat3Ldoub_c cut(Cmat3Ldoub_I v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Ldoub_c sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline Jcmat3Fcomp cut(Cmat3Fcomp_IO v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Fcomp sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline Jcmat3Fcomp_c cut(Cmat3Fcomp_I v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Fcomp_c sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline Jcmat3Lcomp cut(Cmat3Lcomp_IO v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Lcomp sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline Jcmat3Lcomp_c cut(Cmat3Lcomp_I v, Long_I start1, Long_I N1, Long_I start2, Long_I N2, Long_I start3, Long_I N3)
{
    ...
    if (start1 < 0 || start1 + N1 > v.n0() || start2 < 0 || start2 + N2 > v.n1() || start3 < 0 || start3 + N3 > v.n2())
        SLS_ERR("index out of bound!");
#endif
    Jcmat3Lcomp_c sli(&v(start1, start2, start3), N1, N2, N3, 1, v.n0(), v.n0()*v.n1());
    return sli;
}
...
inline SvecComp_c cut0(Scmat3Comp_I v, Long_I j, Long_I k)
{
#ifdef SLS_CHECK_BOUNDS
    if (j < 0 || j >= v.n1() || k < 0 || k >= v.n2())
        SLS_ERR("index out of bound!");
...
inline DvecQdoub_c cut1(ScmatQdoub_I v, Long_I i)
{
#ifdef SLS_CHECK_BOUNDS
    if (i < 0 || i >= v.n0())
        SLS_ERR("index out of bound!");
...
inline DvecDoub_c cut1(CmatDoub_I v, Long_I i, Long_I j, Long_I N2)
{
    ...
    if (i < 0 || i >= v.n0() || j < 0 || j + N2 > v.n1())
        SLS_ERR("out of bound!");
#endif
    DvecDoub_c sli(&v(i, j), N2, v.n0());
    return sli;
}

#ifdef SLS_USE_QUAD_MATH
inline DvecQdoub cut1(CmatQdoub_IO v, Long_I i, Long_I j, Long_I N2)
{
#ifdef SLS_CHECK_BOUNDS
    if (i < 0 || i >= v.n0() || j < 0 || j + N2 > v.n1())
        SLS_ERR("out of bound!");
#endif
    DvecQdoub sli(&v(i, j), N2, v.n0());
    return sli;
}

inline DvecQdoub_c cut1(CmatQdoub_I v, Long_I i, Long_I j, Long_I N2)
{
#ifdef SLS_CHECK_BOUNDS
    if (i < 0 || i >= v.n0() || j < 0 || j + N2 > v.n1())
        SLS_ERR("out of bound!");
#endif
    DvecQdoub_c sli(&v(i, j), N2, v.n0());
    return sli;
}
#endif
...
inline DvecLlong_c cut1(Cmat3Llong_I v, Long_I i, Long_I j, Long_I N2, Long_I k)
{
    ...
    if (i < 0 || i >= v.n0() || j < 0 || j + N2 > v.n1() || k < 0 || k >= v.n2())
        SLS_ERR("out of bound!");
#endif
    DvecLlong_c sli(&v(i, j, k), N2, v.n0());
    return sli;
}
...
inline DvecDoub_c cut1(Cmat3Doub_I v, Long_I i, Long_I j, Long_I N2, Long_I k)
{
    ...
    if (i < 0 || i >= v.n0() || j < 0 || j + N2 > v.n1() || k < 0 || k >= v.n2())
        SLS_ERR("out of bound!");
#endif
    DvecDoub_c sli(&v(i, j, k), N2, v.n0());
    return sli;
}

#ifdef SLS_USE_QUAD_MATH
inline DvecQdoub cut1(Cmat3Qdoub_IO v, Long_I i, Long_I j, Long_I N2, Long_I k)
{
#ifdef SLS_CHECK_BOUNDS
    if (i < 0 || i >= v.n0() || j < 0 || j + N2 > v.n1() || k < 0 || k >= v.n2())
        SLS_ERR("out of bound!");
#endif
    DvecQdoub sli(&v(i, j, k), N2, v.n0());
    return sli;
}

inline DvecQdoub_c cut1(Cmat3Qdoub_I v, Long_I i, Long_I j, Long_I N2, Long_I k)
{
#ifdef SLS_CHECK_BOUNDS
    if (i < 0 || i >= v.n0() || j < 0 || j + N2 > v.n1() || k < 0 || k >= v.n2())
        SLS_ERR("out of bound!");
#endif
    DvecQdoub_c sli(&v(i, j, k), N2, v.n0());
    return sli;
}
#endif
...
inline DvecComp_c cut1(Cmat3Comp_I v, Long_I i, Long_I j, Long_I N2, Long_I k)
{
    ...
    if (i < 0 || i >= v.n0() || j < 0 || j + N2 > v.n1() || k < 0 || k >= v.n2())
        SLS_ERR("out of bound!");
#endif
    DvecComp_c sli(&v(i, j, k), N2, v.n0());
    return sli;
}

#ifdef SLS_USE_QUAD_MATH
inline DvecQcomp cut1(Cmat3Qcomp_IO v, Long_I i, Long_I j, Long_I N2, Long_I k)
{
#ifdef SLS_CHECK_BOUNDS
    if (i < 0 || i >= v.n0() || j < 0 || j + N2 > v.n1() || k < 0 || k >= v.n2())
        SLS_ERR("out of bound!");
#endif
    DvecQcomp sli(&v(i, j, k), N2, v.n0());
    return sli;
}

inline DvecQcomp_c cut1(Cmat3Qcomp_I v, Long_I i, Long_I j, Long_I N2, Long_I k)
{
#ifdef SLS_CHECK_BOUNDS
    if (i < 0 || i >= v.n0() || j < 0 || j + N2 > v.n1() || k < 0 || k >= v.n2())
        SLS_ERR("out of bound!");
#endif
    DvecQcomp_c sli(&v(i, j, k), N2, v.n0());
    return sli;
}
#endif
...
inline ScmatLlong cut01(Cmat4Llong_IO v, Long_I k, Long_I l)
{
    ...
    if (k < 0 || k >= v.n2() || l < 0 || l >= v.n3())
        SLS_ERR("index out of bound!");
#endif
    ScmatLlong sli(&v(0, 0, k, l), v.n0(), v.n1());
    return sli;
}
...
inline ScmatLlong_c cut01(Cmat4Llong_I v, Long_I k, Long_I l)
{
    ...
    if (k < 0 || k >= v.n2() || l < 0 || l >= v.n3())
        SLS_ERR("index out of bound!");
#endif
    ScmatLlong_c sli(&v(0, 0, k, l), v.n0(), v.n1());
    return sli;
}
...
inline ScmatComp cut01(Cmat4Comp_IO v, Long_I k, Long_I l)
{
    ...
    if (k < 0 || k >= v.n2() || l < 0 || l >= v.n3())
        SLS_ERR("index out of bound!");
#endif
    ScmatComp sli(&v(0, 0, k, l), v.n0(), v.n1());
    return sli;
}
...
inline ScmatComp_c cut01(Cmat4Comp_I v, Long_I k, Long_I l)
{
    ...
    if (k < 0 || k >= v.n2() || l < 0 || l >= v.n3())
        SLS_ERR("index out of bound!");
#endif
    ScmatComp_c sli(&v(0, 0, k, l), v.n0(), v.n1());
    return sli;
}
...
inline ScmatInt_c cut01(Cmat3Int_I v, Long_I j, Long_I N2, Long_I k)
{
    ...
    if (j < 0 || j + N2 > v.n1() || k < 0 || k >= v.n2())
        SLS_ERR("index out of bound!");
#endif
    ScmatInt_c sli(&v(0, j, k), v.n0(), N2);
    return sli;
}
