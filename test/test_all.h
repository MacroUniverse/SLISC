...
void test_all()
{
    ...
    cout << "test_bisection()" << endl; test_bisection();
    ...
    cout << "test_legendreP()" << endl; test_legendreP();
    ...
    cout << "test_arpack()" << endl; test_arpack();
    cout << "test_linbcg()" << endl; test_linbcg();
    cout << "test_quad_math()" << endl; test_quad_math();
    cout << "test_eigen()" << endl; test_eigen();
