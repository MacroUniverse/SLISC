...
RUN	cd ~/SQLiteCpp-3.2.1 && \
	cmake -D CMAKE_BUILD_TYPE=Release -D CMAKE_INSTALL_PREFIX=$INSTALL_DIR/sqlitecpp-3.2.1 -D SQLITE_ENABLE_COLUMN_METADATA=OFF -D SQLITECPP_RUN_CPPCHECK=OFF -D SQLITECPP_RUN_CPPLINT=OFF . && \
