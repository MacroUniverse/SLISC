...
# icpx is the future replacement of icpc, which is deprecated
compiler = icpx
...
# All
compiler_flag = -std=c++11 -Wall -Wno-reorder-ctor -Wno-debug-disables-optimization -fp-model precise -qopenmp -Qoption,cpp,--extended_float_types  $(debug_flag) $(release_flag)
