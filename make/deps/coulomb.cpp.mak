...
tests/coulomb.o: tests/coulomb.cpp tests/../SLISC/arith/arith2.h \
 ...
 tests/../SLISC/spec/coulomb.h tests/../SLISC/spec/cwfcomp/cwfcomp.h \
 tests/../SLISC/spec/cwfcomp/complex_functions.h \
 tests/../SLISC/spec/cwfcomp/cwfcomp.inl
	$(opt_compiler) $(all_flags) -c tests/coulomb.cpp -o tests/coulomb.o
