...
tests/arithmetic.o: tests/arithmetic.cpp tests/../SLISC/arith/arith1.h \
 ...
 tests/../SLISC/algo/../arith/reorder.h tests/../SLISC/str/disp.h
	$(opt_compiler) $(all_flags) -c tests/arithmetic.cpp -o tests/arithmetic.o
