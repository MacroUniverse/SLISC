...
tests/dense.o: tests/dense.cpp tests/../SLISC/arith/arith2.h \
 ...
 tests/../SLISC/util/../util/STL_util.h tests/../SLISC/dense/WorkSpace.h
	$(opt_compiler) $(all_flags) -c tests/dense.cpp -o tests/dense.o
