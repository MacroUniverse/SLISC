...
namespace slisc {
inline constexpr Bool operator==(Char_I s1, Fcomp_I s2) { return real(s2) == s1 && imag(s2) == 0; }
inline constexpr Bool operator!=(Char_I s1, Fcomp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Char_I s1, Comp_I s2) { return real(s2) == s1 && imag(s2) == 0; }
inline constexpr Bool operator!=(Char_I s1, Comp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Char_I s1, Lcomp_I s2) { return real(s2) == s1 && imag(s2) == 0; }
inline constexpr Bool operator!=(Char_I s1, Lcomp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Int_I s1, Fcomp_I s2) { return real(s2) == s1 && imag(s2) == 0; }
inline constexpr Bool operator!=(Int_I s1, Fcomp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Int_I s1, Comp_I s2) { return real(s2) == s1 && imag(s2) == 0; }
inline constexpr Bool operator!=(Int_I s1, Comp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Int_I s1, Lcomp_I s2) { return real(s2) == s1 && imag(s2) == 0; }
inline constexpr Bool operator!=(Int_I s1, Lcomp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Float_I s1, Comp_I s2) { return real(s2) == s1 && imag(s2) == 0; }
inline constexpr Bool operator!=(Float_I s1, Comp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Float_I s1, Lcomp_I s2) { return real(s2) == s1 && imag(s2) == 0; }
inline constexpr Bool operator!=(Float_I s1, Lcomp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Doub_I s1, Fcomp_I s2) { return real(s2) == s1 && imag(s2) == 0; }
inline constexpr Bool operator!=(Doub_I s1, Fcomp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Doub_I s1, Lcomp_I s2) { return real(s2) == s1 && imag(s2) == 0; }
inline constexpr Bool operator!=(Doub_I s1, Lcomp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Ldoub_I s1, Fcomp_I s2) { return real(s2) == s1 && imag(s2) == 0; }
inline constexpr Bool operator!=(Ldoub_I s1, Fcomp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Ldoub_I s1, Comp_I s2) { return real(s2) == s1 && imag(s2) == 0; }
inline constexpr Bool operator!=(Ldoub_I s1, Comp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Fcomp_I s1, Char_I s2) { return real(s1) == s2 && imag(s1) == 0; }
inline constexpr Bool operator!=(Fcomp_I s1, Char_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Comp_I s1, Char_I s2) { return real(s1) == s2 && imag(s1) == 0; }
inline constexpr Bool operator!=(Comp_I s1, Char_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Lcomp_I s1, Char_I s2) { return real(s1) == s2 && imag(s1) == 0; }
inline constexpr Bool operator!=(Lcomp_I s1, Char_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Fcomp_I s1, Int_I s2) { return real(s1) == s2 && imag(s1) == 0; }
inline constexpr Bool operator!=(Fcomp_I s1, Int_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Comp_I s1, Int_I s2) { return real(s1) == s2 && imag(s1) == 0; }
inline constexpr Bool operator!=(Comp_I s1, Int_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Lcomp_I s1, Int_I s2) { return real(s1) == s2 && imag(s1) == 0; }
inline constexpr Bool operator!=(Lcomp_I s1, Int_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Comp_I s1, Float_I s2) { return real(s1) == s2 && imag(s1) == 0; }
inline constexpr Bool operator!=(Comp_I s1, Float_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Lcomp_I s1, Float_I s2) { return real(s1) == s2 && imag(s1) == 0; }
inline constexpr Bool operator!=(Lcomp_I s1, Float_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Fcomp_I s1, Doub_I s2) { return real(s1) == s2 && imag(s1) == 0; }
inline constexpr Bool operator!=(Fcomp_I s1, Doub_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Lcomp_I s1, Doub_I s2) { return real(s1) == s2 && imag(s1) == 0; }
inline constexpr Bool operator!=(Lcomp_I s1, Doub_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Fcomp_I s1, Ldoub_I s2) { return real(s1) == s2 && imag(s1) == 0; }
inline constexpr Bool operator!=(Fcomp_I s1, Ldoub_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Comp_I s1, Ldoub_I s2) { return real(s1) == s2 && imag(s1) == 0; }
inline constexpr Bool operator!=(Comp_I s1, Ldoub_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Fcomp_I s1, Comp_I s2) { return real(s1) == real(s2) && imag(s1) == imag(s2); }
inline constexpr Bool operator!=(Fcomp_I s1, Comp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Fcomp_I s1, Lcomp_I s2) { return real(s1) == real(s2) && imag(s1) == imag(s2); }
inline constexpr Bool operator!=(Fcomp_I s1, Lcomp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Comp_I s1, Fcomp_I s2) { return real(s1) == real(s2) && imag(s1) == imag(s2); }
inline constexpr Bool operator!=(Comp_I s1, Fcomp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Comp_I s1, Lcomp_I s2) { return real(s1) == real(s2) && imag(s1) == imag(s2); }
inline constexpr Bool operator!=(Comp_I s1, Lcomp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Lcomp_I s1, Fcomp_I s2) { return real(s1) == real(s2) && imag(s1) == imag(s2); }
inline constexpr Bool operator!=(Lcomp_I s1, Fcomp_I s2) { return !(s1 == s2); }

inline constexpr Bool operator==(Lcomp_I s1, Comp_I s2) { return real(s1) == real(s2) && imag(s1) == imag(s2); }
inline constexpr Bool operator!=(Lcomp_I s1, Comp_I s2) { return !(s1 == s2); }
...
inline void operator+=(Fcomp_O z, Doub_I x) { z += (Float)x; }
inline void operator-=(Fcomp_O z, Doub_I x) { z -= (Float)x; }
inline void operator*=(Fcomp_O z, Doub_I x) { z *= (Float)x; }
inline void operator/=(Fcomp_O z, Doub_I x) { z /= (Float)x; }

inline void operator+=(Fcomp_O z, Ldoub_I x) { z += (Float)x; }
inline void operator-=(Fcomp_O z, Ldoub_I x) { z -= (Float)x; }
inline void operator*=(Fcomp_O z, Ldoub_I x) { z *= (Float)x; }
inline void operator/=(Fcomp_O z, Ldoub_I x) { z /= (Float)x; }
...
inline void operator+=(Comp_O z, Ldoub_I x) { z += (Doub)x; }
inline void operator-=(Comp_O z, Ldoub_I x) { z -= (Doub)x; }
inline void operator*=(Comp_O z, Ldoub_I x) { z *= (Doub)x; }
inline void operator/=(Comp_O z, Ldoub_I x) { z /= (Doub)x; }
...
inline void operator+=(Fcomp_O z, Comp_I x) { z += (Fcomp)x; }
inline void operator-=(Fcomp_O z, Comp_I x) { z -= (Fcomp)x; }
inline void operator*=(Fcomp_O z, Comp_I x) { z *= (Fcomp)x; }
inline void operator/=(Fcomp_O z, Comp_I x) { z /= (Fcomp)x; }

inline void operator+=(Fcomp_O z, Lcomp_I x) { z += (Fcomp)x; }
inline void operator-=(Fcomp_O z, Lcomp_I x) { z -= (Fcomp)x; }
inline void operator*=(Fcomp_O z, Lcomp_I x) { z *= (Fcomp)x; }
inline void operator/=(Fcomp_O z, Lcomp_I x) { z /= (Fcomp)x; }
...
inline void operator+=(Comp_O z, Lcomp_I x) { z += (Comp)x; }
inline void operator-=(Comp_O z, Lcomp_I x) { z -= (Comp)x; }
inline void operator*=(Comp_O z, Lcomp_I x) { z *= (Comp)x; }
inline void operator/=(Comp_O z, Lcomp_I x) { z /= (Comp)x; }
