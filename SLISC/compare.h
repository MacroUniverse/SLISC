...
inline Bool shape_cmp(VecDoub_I v1, SvecDoub_I v2)
{
    return v1.size() == v2.size();
}
...
inline Bool shape_cmp(VecDoub_I v1, VecChar_I v2)
{
    return v1.size() == v2.size();
}
...
inline Bool shape_cmp(VecDoub_I v1, SvecComp_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(VecLlong_I v1, VecInt_I v2)
{
    return v1.size() == v2.size();
}
...
inline Bool shape_cmp(VecComp_I v1, SvecDoub_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(VecComp_I v1, SvecComp_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(VecComp_I v1, DvecComp_I v2)
{
    return v1.size() == v2.size();
}
...
inline Bool shape_cmp(CmatDoub_I v1, ScmatDoub_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}

inline Bool shape_cmp(CmatDoub_I v1, DcmatDoub_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}
...
inline Bool shape_cmp(CmatDoub_I v1, CmobdDoub_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}
...
inline Bool shape_cmp(CmatComp_I v1, ScmatComp_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}

inline Bool shape_cmp(CmatComp_I v1, DcmatComp_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}
...
inline Bool shape_cmp(DcmatLlong_I v1, DcmatLlong_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}
...
inline Bool shape_cmp(DcmatComp_I v1, DcmatDoub_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}

inline Bool shape_cmp(DcmatComp_I v1, CmatComp_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}

inline Bool shape_cmp(DcmatDoub_I v1, DcmatComp_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}

inline Bool shape_cmp(DcmatComp_I v1, DcmatComp_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}

inline Bool shape_cmp(Cmat3Int_I v1, Cmat3Int_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2()
            && v1.n3() == v2.n3();
}
...
inline Bool shape_cmp(Cmat3Doub_I v1, Cmat3Comp_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2()
            && v1.n3() == v2.n3();
}

inline Bool shape_cmp(Cmat3Comp_I v1, Cmat3Doub_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2()
            && v1.n3() == v2.n3();
}
...
inline Bool shape_cmp(McooComp_I v1, McooDoub_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}
...
inline Bool shape_cmp(SvecChar_I v1, SvecChar_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecInt_I v1, SvecInt_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecInt_I v1, DvecInt_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecLlong_I v1, SvecLlong_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecLlong_I v1, DvecLlong_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecFloat_I v1, SvecFloat_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecDoub_I v1, VecDoub_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecDoub_I v1, SvecDoub_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecDoub_I v1, SvecComp_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecDoub_I v1, DvecDoub_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecLdoub_I v1, SvecLdoub_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecFcomp_I v1, SvecFcomp_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecComp_I v1, VecComp_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecComp_I v1, SvecDoub_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecComp_I v1, SvecComp_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(SvecComp_I v1, DvecComp_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(ScmatInt_I v1, ScmatInt_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}

inline Bool shape_cmp(ScmatLlong_I v1, ScmatLlong_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}

inline Bool shape_cmp(ScmatDoub_I v1, CmatDoub_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}
...
inline Bool shape_cmp(DvecChar_I v1, DvecChar_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(DvecInt_I v1, DvecInt_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(DvecLlong_I v1, DvecLlong_I v2)
{
    return v1.size() == v2.size();
}
...
inline Bool shape_cmp(DvecComp_I v1, SvecDoub_I v2)
{
    return v1.size() == v2.size();
}

inline Bool shape_cmp(DvecComp_I v1, SvecComp_I v2)
{
    return v1.size() == v2.size();
}
...
inline Bool shape_cmp(CmobdInt_I v1, McooInt_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}
...
inline Bool shape_cmp(CmobdComp_I v1, McooDoub_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}

inline Bool shape_cmp(CbandDoub_I v1, CbandDoub_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}
...
inline Bool shape_cmp(CbandDoub_I v1, CbandComp_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}

inline Bool shape_cmp(CbandComp_I v1, CbandComp_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}
...
inline Bool shape_cmp(CbandComp_I v1, CbandDoub_I v2)
{
    return v1.n1() == v2.n1() && v1.n2() == v2.n2();
}
