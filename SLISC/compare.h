...
namespace slisc {
inline Bool equals_to_vs(const Comp *v, Doub_I s, Long_I N)
{
    for (Long i = 0; i < N; ++i)
        if (v[i] != s)
            return false;
...
inline Bool shape_cmp(CbandComp_I v1, ScmatDoub_I v2) {return (Long)v1.n0() == (Long)v2.n0() && (Long)v1.n1() == (Long)v2.n1();}
