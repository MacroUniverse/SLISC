...
inline Long size(vecLdoub_I v)
{
    return v.size();
}

#ifdef SLS_USE_QUAD_MATH
inline Long size(vecQdoub_I v)
{
    return v.size();
}
#endif

inline Long size(vecComp_I v)
{
    return v.size();
}

inline Long size(vecLcomp_I v)
{
    return v.size();
}

#ifdef SLS_USE_QUAD_MATH
inline Long size(vecQcomp_I v)
{
    return v.size();
}
#endif
...
inline Qdoub max_v(const Qdoub *v, Long_I N)
{
#ifdef SLS_CHECK_BOUNDS
    if (N <= 0) SLS_ERR("illegal length!");
#endif
...
inline Qdoub max_v(const Qdoub *v, Long_I N, Long_I step)
{
#ifdef SLS_CHECK_BOUNDS
    if (N <= 0) SLS_ERR("illegal length!");
#endif
...
inline Qdoub max_v(Long_O ind, const Qdoub *v, Long_I N)
{
#ifdef SLS_CHECK_BOUNDS
    if (N <= 0) SLS_ERR("illegal length!");
#endif
...
inline Qdoub max_v(Long_O ind, const Qdoub *v, Long_I N, Long_I step)
{
#ifdef SLS_CHECK_BOUNDS
    if (N <= 0) SLS_ERR("illegal length!");
#endif
...
inline Qdoub min_v(const Qdoub *v, Long_I N)
{
#ifdef SLS_CHECK_BOUNDS
    if (N <= 0) SLS_ERR("illegal length!");
#endif
...
inline Qdoub min_v(const Qdoub *v, Long_I N, Long_I step)
{
#ifdef SLS_CHECK_BOUNDS
    if (N <= 0) SLS_ERR("illegal length!");
#endif
...
inline Qdoub min_v(Long_O ind, const Qdoub *v, Long_I N)
{
#ifdef SLS_CHECK_BOUNDS
    if (N <= 0) SLS_ERR("illegal length!");
#endif
...
inline Qdoub min_v(Long_O ind, const Qdoub *v, Long_I N, Long_I step)
{
#ifdef SLS_CHECK_BOUNDS
    if (N <= 0) SLS_ERR("illegal length!");
#endif
...
inline Ldoub max_abs_v(const Ldoub *v, Long_I N)
{
#ifdef SLS_CHECK_BOUNDS
    if (N <= 0) SLS_ERR("illegal length!");
#endif
...
inline Ldoub max_abs_v(const Ldoub *v, Long_I N, Long_I step)
{
#ifdef SLS_CHECK_BOUNDS
    if (N <= 0) SLS_ERR("illegal length!");
#endif
...
inline Ldoub max_abs_v(const Lcomp *v, Long_I N)
{
#ifdef SLS_CHECK_BOUNDS
    if (N <= 0) SLS_ERR("illegal length!");
#endif
...
inline Ldoub max_abs_v(const Lcomp *v, Long_I N, Long_I step)
{
#ifdef SLS_CHECK_BOUNDS
    if (N <= 0) SLS_ERR("illegal length!");
#endif
...
inline Ldoub max_abs(VecLdoub_I v)
{
    return max_abs_v(v.p(), v.size());
}
...
inline Ldoub max_abs(VecLcomp_I v)
{
    return max_abs_v(v.p(), v.size());
}

inline Qdoub max_abs(VecQcomp_I v)
{
    return max_abs_v(v.p(), v.size());
}
...
inline void mod_vvs(Ldoub *v, const Ldoub *v1, Ldoub_I s, Long_I N)
{
    for (Long i = 0; i < N; ++i)
        v[i] = mod(v1[i], s);
}

inline void mod_vs(Ldoub *v, Ldoub_I s, Long_I N)
{
    for (Long i = 0; i < N; ++i)
        v[i] = mod(v[i], s);
}
...
inline void mod_vs(Qdoub *v, Qdoub_I s, Long_I N)
{
    for (Long i = 0; i < N; ++i)
        v[i] = mod(v[i], s);
}
...
inline void plus(ScmatComp_O v, ScmatDoub_I v1, Doub_I s)
{
    assert_same_shape22(v, v1);
    plus_vvs(v.p(), v1.p(), s, v1.size());
}

inline void plus(ScmatComp_O v, Doub_I s, ScmatDoub_I v1)
{
    plus(v, v1, s);
}

inline void minus(ScmatComp_O v, ScmatDoub_I v1, Doub_I s)
{
    assert_same_shape22(v, v1);
    minus_vvs(v.p(), v1.p(), s, v1.size());
}

inline void minus(ScmatComp_O v, Doub_I s, ScmatDoub_I v1)
{
    assert_same_shape22(v, v1);
    minus_vsv(v.p(), s, v1.p(), v1.size());
}

inline void times(ScmatComp_O v, ScmatDoub_I v1, Doub_I s)
{
    assert_same_shape22(v, v1);
    times_vvs(v.p(), v1.p(), s, v1.size());
}

inline void times(ScmatComp_O v, Doub_I s, ScmatDoub_I v1)
{
    times(v, v1, s);
}

inline void divide(ScmatComp_O v, ScmatDoub_I v1, Doub_I s)
{
    assert_same_shape22(v, v1);
    divide_vvs(v.p(), v1.p(), s, v1.size());
}

inline void divide(ScmatComp_O v, Doub_I s, ScmatDoub_I v1)
{
    assert_same_shape22(v, v1);
    divide_vsv(v.p(), s, v1.p(), v1.size());
}
...
inline void mul(VecComp_O y, CmatDoub_I a, SvecComp_I x)
{
    Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
    if (Nc != x.size() || y.size() != Nr)
...
// y = alpha*A*x + beta*y
// algorithm: y = alpha*(A*x + beta/alpha *y)
inline void mul(VecComp_IO y, CmatDoub_I a, SvecComp_I x, Doub_I alpha, Comp_I beta)
{
    Long Nr = a.n0(), Nc = a.n1();
#ifdef SLS_CHECK_SHAPES
    if (Nc != x.size() || y.size() != Nr)
...
inline void mul_gen(DvecComp_O &y, DcmatDoub_I a, DvecComp_I x, Doub_I alpha = 1, Doub_I beta = 0)
{
    ...
    // do real part
    cblas_dgemv(CblasColMajor, CblasNoTrans, a.n0(), a.n1(), alpha, a.p(),
        a.lda(), (Doub*)x.p(), 2*x.step(), beta, (Doub*)y.p(), 2*y.step());
    // do imag part
    cblas_dgemv(CblasColMajor, CblasNoTrans, a.n0(), a.n1(), alpha, a.p(),
