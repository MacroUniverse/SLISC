...
public:
    SvbaseQdoub_c();
    explicit SvbaseQdoub_c(Long_I N);
    SvbaseQdoub_c(const Qdoub *data, Long_I N); // unsafe
    const Qdoub* p() const;
    Long size() const;
    SvbaseQdoub_c &operator=(const SvbaseQdoub_c &rhs) = delete;
    const Qdoub &operator[](Long_I i) const;
    const Qdoub &end() const;
    const Qdoub &end(Long_I i) const;
    void set(const SvbaseQdoub_c &sli);
    void next(); // m_p += m_N
...
inline SvbaseQdoub_c::SvbaseQdoub_c() {}

inline SvbaseQdoub_c::SvbaseQdoub_c(Long_I N) : m_N(N)
{
#ifdef SLS_CHECK_BOUNDS
    m_p = nullptr;
#endif
...
inline SvbaseQdoub_c::SvbaseQdoub_c(const Qdoub *data, Long_I N)
    : m_p(data), m_N(N) {}

inline const Qdoub * SvbaseQdoub_c::p() const
{
#ifdef SLS_CHECK_BOUNDS
    if (m_N == 0)
        SLS_ERR("using p() for empty container!");
...
inline Long SvbaseQdoub_c::size() const
{
    return m_N;
}

inline const Qdoub &SvbaseQdoub_c::operator[](Long_I i) const
{
#ifdef SLS_CHECK_BOUNDS
    if (i < 0 || i >= m_N)
        SLS_ERR("Vbase subscript out of bounds");
...
inline const Qdoub &SvbaseQdoub_c::end() const
{
#ifdef SLS_CHECK_BOUNDS
    if (m_N == 0)
        SLS_ERR("tring to use end() on empty vector!");
...
inline const Qdoub &SvbaseQdoub_c::end(Long_I i) const
{
#ifdef SLS_CHECK_BOUNDS
    if (i <= 0 || i > m_N)
        SLS_ERR("index out of bound");
...
inline void SvbaseQdoub_c::set(const Qdoub *data, Long_I N)
{
    m_p = data; m_N = N;
}

inline void SvbaseQdoub_c::set(const Qdoub *data)
{
    m_p = data;
}

inline void SvbaseQdoub_c::set(Long_I N)
{
    m_N = N;
}

inline void SvbaseQdoub_c::next()
{
    m_p += m_N;
}

inline void SvbaseQdoub_c::last()
{
    m_p -= m_N;
}

inline void SvbaseQdoub_c::shift(Long_I N)
{
    m_p += N;
}

inline void SvbaseQdoub_c::set(const SvbaseQdoub_c &sli)
{
    m_p = sli.m_p; m_N = sli.m_N;
}
...
public:
    ...
    SvbaseQdoub(Qdoub *data, Long_I N); // unsafe
    Qdoub* p() const;
    Long size() const;
...
inline SvbaseQdoub::operator SvbaseQdoub_c() const
{
    return *((SvbaseQdoub_c *)this);
}
...
public:
    SvbaseQcomp_c();
    explicit SvbaseQcomp_c(Long_I N);
    SvbaseQcomp_c(const Qcomp *data, Long_I N); // unsafe
    const Qcomp* p() const;
    Long size() const;
    SvbaseQcomp_c &operator=(const SvbaseQcomp_c &rhs) = delete;
    const Qcomp &operator[](Long_I i) const;
    const Qcomp &end() const;
    const Qcomp &end(Long_I i) const;
    void set(const SvbaseQcomp_c &sli);
    void next(); // m_p += m_N
...
inline SvbaseQcomp_c::SvbaseQcomp_c() {}

inline SvbaseQcomp_c::SvbaseQcomp_c(Long_I N) : m_N(N)
{
#ifdef SLS_CHECK_BOUNDS
    m_p = nullptr;
#endif
...
inline SvbaseQcomp_c::SvbaseQcomp_c(const Qcomp *data, Long_I N)
    : m_p(data), m_N(N) {}

inline const Qcomp * SvbaseQcomp_c::p() const
{
#ifdef SLS_CHECK_BOUNDS
    if (m_N == 0)
        SLS_ERR("using p() for empty container!");
...
inline Long SvbaseQcomp_c::size() const
{
    return m_N;
}

inline const Qcomp &SvbaseQcomp_c::operator[](Long_I i) const
{
#ifdef SLS_CHECK_BOUNDS
    if (i < 0 || i >= m_N)
        SLS_ERR("Vbase subscript out of bounds");
...
inline const Qcomp &SvbaseQcomp_c::end() const
{
#ifdef SLS_CHECK_BOUNDS
    if (m_N == 0)
        SLS_ERR("tring to use end() on empty vector!");
...
inline const Qcomp &SvbaseQcomp_c::end(Long_I i) const
{
#ifdef SLS_CHECK_BOUNDS
    if (i <= 0 || i > m_N)
        SLS_ERR("index out of bound");
...
inline void SvbaseQcomp_c::set(const Qcomp *data, Long_I N)
{
    m_p = data; m_N = N;
}

inline void SvbaseQcomp_c::set(const Qcomp *data)
{
    m_p = data;
}

inline void SvbaseQcomp_c::set(Long_I N)
{
    m_N = N;
}

inline void SvbaseQcomp_c::next()
{
    m_p += m_N;
}

inline void SvbaseQcomp_c::last()
{
    m_p -= m_N;
}

inline void SvbaseQcomp_c::shift(Long_I N)
{
    m_p += N;
}

inline void SvbaseQcomp_c::set(const SvbaseQcomp_c &sli)
{
    m_p = sli.m_p; m_N = sli.m_N;
}
...
public:
    ...
    SvbaseQcomp(Qcomp *data, Long_I N); // unsafe
    Qcomp* p() const;
    Long size() const;
...
inline SvbaseQcomp::operator SvbaseQcomp_c() const
{
    return *((SvbaseQcomp_c *)this);
}
...
public:
    SvecQdoub_c() = default;
    explicit SvecQdoub_c(Long_I N);
    SvecQdoub_c(const Qdoub *data, Long_I N); // unsafe
    SvecQdoub_c &operator=(const SvecQdoub_c &rhs) = delete;
};

inline SvecQdoub_c::SvecQdoub_c(Long_I N) : SvbaseQdoub_c(N)
{}

inline SvecQdoub_c::SvecQdoub_c(const Qdoub *data, Long_I N)
    : SvbaseQdoub_c(data, N) {}
...
public:
    ...
    SvecQdoub(Qdoub *data, Long_I N); // unsafe
    SvecQdoub &operator=(const SvecQdoub &rhs) = delete;
    operator SvecQdoub_c() const;
};
...
inline SvecQdoub::operator SvecQdoub_c() const
{
    return *((SvecQdoub_c *)this);
}
...
public:
    SvecQcomp_c() = default;
    explicit SvecQcomp_c(Long_I N);
    SvecQcomp_c(const Qcomp *data, Long_I N); // unsafe
    SvecQcomp_c &operator=(const SvecQcomp_c &rhs) = delete;
};

inline SvecQcomp_c::SvecQcomp_c(Long_I N) : SvbaseQcomp_c(N)
{}

inline SvecQcomp_c::SvecQcomp_c(const Qcomp *data, Long_I N)
    : SvbaseQcomp_c(data, N) {}
...
public:
    ...
    SvecQcomp(Qcomp *data, Long_I N); // unsafe
    SvecQcomp &operator=(const SvecQcomp &rhs) = delete;
    operator SvecQcomp_c() const;
};
...
inline SvecQcomp::operator SvecQcomp_c() const
{
    return *((SvecQcomp_c *)this);
}
