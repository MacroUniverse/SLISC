...
inline Doub exp_Hdt_v_lanc(DvecComp_O y, CbandDoub_I H, DvecComp_I x, Doub_I dt, Long_I Nkrylov, SvecDoub_IO wsp_d, SvecComp_IO wsp_c)
{
    Long N = x.size(), Nk = Nkrylov;
#ifdef SLS_CHECK_SHAPES
    if (Nk > N)
...
inline Doub exp_Hdt_v_lanc(DvecComp_O y, McooDoub_I H, DvecComp_I x, Doub_I dt, Long_I Nkrylov, VecDoub_IO wsp_d, VecComp_IO wsp_c)
{
    Long N = x.size(), Nk = Nkrylov;
#ifdef SLS_CHECK_SHAPES
    if (Nk > N)
...
inline Doub exp_miHdt_v_lanc(VecComp_IO y, CmatDoub_I H, VecComp_IO x, Doub_I dt, Long_I Nkrylov, SvecDoub_IO wsp_d, SvecComp_IO wsp_c)
{
    Long N = x.size(), Nk = Nkrylov;
#ifdef SLS_CHECK_SHAPES
    if (Nk > N)
...
inline Doub exp_miHdt_v_lanc(DvecComp_IO y, CmobdDoub_I H, DvecComp_IO x, Doub_I dt, Long_I Nkrylov, VecDoub_IO wsp_d, VecComp_IO wsp_c)
{
    Long N = x.size(), Nk = Nkrylov;
#ifdef SLS_CHECK_SHAPES
    if (Nk > N)
...
inline Doub exp_miHdt_v_lanc(DvecComp_IO y, CbandDoub_I H, DvecComp_IO x, Doub_I dt, Long_I Nkrylov, VecDoub_IO wsp_d, VecComp_IO wsp_c)
{
    Long N = x.size(), Nk = Nkrylov;
#ifdef SLS_CHECK_SHAPES
    if (Nk > N)
...
inline Doub exp_miHdt_v_lanc(DvecComp_IO y, McooDoub_I H, DvecComp_IO x, Doub_I dt, Long_I Nkrylov, VecDoub_IO wsp_d, VecComp_IO wsp_c)
{
    Long N = x.size(), Nk = Nkrylov;
#ifdef SLS_CHECK_SHAPES
    if (Nk > N)
